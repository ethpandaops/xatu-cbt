CREATE TABLE mainnet.int_address__account_last_access_local on cluster '{cluster}' (
...
CREATE TABLE mainnet.int_address__account_last_access ON CLUSTER '{cluster}' AS mainnet.int_address__account_last_access_local ENGINE = Distributed(
    '{cluster}',
    mainnet,
...
CREATE TABLE mainnet.int_address__account_first_access_local on cluster '{cluster}' (
    `address` String COMMENT 'The address of the account' CODEC(ZSTD(1)),
...
CREATE TABLE mainnet.int_address__account_first_access ON CLUSTER '{cluster}' AS mainnet.int_address__account_first_access_local ENGINE = Distributed(
    '{cluster}',
    mainnet,
...
CREATE TABLE mainnet.int_address__storage_slot_last_access_local on cluster '{cluster}' (
    `address` String COMMENT 'The address of the account' CODEC(ZSTD(1)),
...
CREATE TABLE mainnet.int_address__storage_slot_last_access ON CLUSTER '{cluster}' AS mainnet.int_address__storage_slot_last_access_local ENGINE = Distributed(
    '{cluster}',
    mainnet,
...
CREATE TABLE mainnet.int_address__storage_slot_first_access_local on cluster '{cluster}' (
    `address` String COMMENT 'The address of the account' CODEC(ZSTD(1)),
    `slot_key` String COMMENT 'The slot key of the storage' CODEC(ZSTD(1)),
    `block_number` UInt32 COMMENT 'The block number of the first access' CODEC(ZSTD(1)),
    `value` String COMMENT 'The value of the storage' CODEC(ZSTD(1)),
...
CREATE TABLE mainnet.int_address__storage_slot_first_access ON CLUSTER '{cluster}' AS mainnet.int_address__storage_slot_first_access_local ENGINE = Distributed(
    '{cluster}',
    mainnet,
