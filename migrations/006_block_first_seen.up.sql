CREATE TABLE fct_block_first_seen_by_node_local on cluster '{cluster}' (
...
CREATE TABLE fct_block_first_seen_by_node ON CLUSTER '{cluster}' AS fct_block_first_seen_by_node_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
...
ALTER TABLE fct_block_first_seen_by_node_local ON CLUSTER '{cluster}'
