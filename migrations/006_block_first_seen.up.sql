CREATE TABLE `${NETWORK_NAME}`.int_blocks_first_seen_by_nodes_local on cluster '{cluster}' (
...
CREATE TABLE `${NETWORK_NAME}`.int_blocks_first_seen_by_nodes ON CLUSTER '{cluster}' AS `${NETWORK_NAME}`.int_blocks_first_seen_by_nodes_local ENGINE = Distributed(
    '{cluster}',
    '${NETWORK_NAME}',
    int_blocks_first_seen_by_nodes_local,
