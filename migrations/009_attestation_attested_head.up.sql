CREATE TABLE int_attestation_attested_head_local on cluster '{cluster}' (
...
CREATE TABLE int_attestation_attested_head ON CLUSTER '{cluster}' AS int_attestation_attested_head_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
    int_attestation_attested_head_local,
