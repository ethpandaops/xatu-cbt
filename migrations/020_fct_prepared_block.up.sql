CREATE TABLE fct_prepared_block_local on cluster '{cluster}' (
...
CREATE TABLE fct_prepared_block ON CLUSTER '{cluster}' AS fct_prepared_block_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
...
ALTER TABLE fct_prepared_block_local ON CLUSTER '{cluster}'
