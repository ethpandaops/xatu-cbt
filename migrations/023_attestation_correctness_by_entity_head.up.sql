CREATE TABLE `${NETWORK_NAME}`.fct_attestation_correctness_by_entity_head_local on cluster '{cluster}' (
    ...
    `entity` Nullable(String) COMMENT 'The entity associated with the validators' CODEC(ZSTD(1)),
...
COMMENT 'Attestation correctness aggregated by entity for the head chain.';
