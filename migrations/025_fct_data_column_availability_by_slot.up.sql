CREATE TABLE `${NETWORK_NAME}`.fct_data_column_availability_by_slot_local on cluster '{cluster}' (
...
ALTER TABLE `${NETWORK_NAME}`.fct_data_column_availability_by_slot_local ON CLUSTER '{cluster}'
