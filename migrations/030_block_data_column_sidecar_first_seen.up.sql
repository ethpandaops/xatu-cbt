CREATE TABLE fct_block_data_column_sidecar_first_seen_by_node_local on cluster '{cluster}' (
...
CREATE TABLE fct_block_data_column_sidecar_first_seen_by_node ON CLUSTER '{cluster}' AS fct_block_data_column_sidecar_first_seen_by_node_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
    fct_block_data_column_sidecar_first_seen_by_node_local,
    cityHash64(`slot_start_date_time`, `meta_client_name`)
);

ALTER TABLE fct_block_data_column_sidecar_first_seen_by_node_local ON CLUSTER '{cluster}'
