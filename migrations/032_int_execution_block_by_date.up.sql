CREATE TABLE int_execution_block_by_date_local ON CLUSTER '{cluster}' (
...
CREATE TABLE int_execution_block_by_date ON CLUSTER '{cluster}' AS int_execution_block_by_date_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
