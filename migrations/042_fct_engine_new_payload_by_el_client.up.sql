CREATE TABLE fct_engine_new_payload_by_el_client_local ON CLUSTER '{cluster}' (
...
CREATE TABLE fct_engine_new_payload_by_el_client ON CLUSTER '{cluster}'
AS fct_engine_new_payload_by_el_client_local
ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
