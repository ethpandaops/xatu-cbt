CREATE TABLE `${NETWORK_NAME}`.fct_engine_new_payload_status_hourly_local ON CLUSTER '{cluster}' (
...
CREATE TABLE `${NETWORK_NAME}`.fct_engine_new_payload_status_hourly ON CLUSTER '{cluster}'
AS `${NETWORK_NAME}`.fct_engine_new_payload_status_hourly_local
ENGINE = Distributed(
    '{cluster}',
    '${NETWORK_NAME}',
    fct_engine_new_payload_status_hourly_local,
