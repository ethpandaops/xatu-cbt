CREATE TABLE fct_engine_new_payload_status_daily_local ON CLUSTER '{cluster}' (
...
CREATE TABLE fct_engine_new_payload_status_daily ON CLUSTER '{cluster}'
AS fct_engine_new_payload_status_daily_local
ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
