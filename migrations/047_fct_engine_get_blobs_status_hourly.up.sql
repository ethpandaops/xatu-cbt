CREATE TABLE fct_engine_get_blobs_status_hourly_local ON CLUSTER '{cluster}' (
...
CREATE TABLE fct_engine_get_blobs_status_hourly ON CLUSTER '{cluster}'
AS fct_engine_get_blobs_status_hourly_local
ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
