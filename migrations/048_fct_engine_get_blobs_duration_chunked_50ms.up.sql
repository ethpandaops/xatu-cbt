CREATE TABLE fct_engine_get_blobs_duration_chunked_50ms_local ON CLUSTER '{cluster}' (
...
CREATE TABLE fct_engine_get_blobs_duration_chunked_50ms ON CLUSTER '{cluster}'
AS fct_engine_get_blobs_duration_chunked_50ms_local
ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
    fct_engine_get_blobs_duration_chunked_50ms_local,
    cityHash64(slot_start_date_time, block_root, node_class, chunk_duration_ms)
);
