...
-- Re-add min_depth/max_depth columns to int_transaction_call_frame_opcode_gas_local
...
-- Re-add min_depth/max_depth columns to int_transaction_opcode_gas_local
