...
CREATE TABLE fct_node_memory_usage_by_process_local ON CLUSTER '{cluster}' (
...
CREATE TABLE fct_node_memory_usage_by_process ON CLUSTER '{cluster}' AS fct_node_memory_usage_by_process_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
