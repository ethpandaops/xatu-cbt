...
CREATE TABLE fct_node_disk_io_by_process_local ON CLUSTER '{cluster}' (
...
CREATE TABLE fct_node_disk_io_by_process ON CLUSTER '{cluster}' AS fct_node_disk_io_by_process_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
