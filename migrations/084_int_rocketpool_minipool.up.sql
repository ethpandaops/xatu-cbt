-- ============================================================================
-- Migration 084: Rocket Pool minipool lifecycle events
-- ============================================================================
-- Adds:
--   1. int_rocketpool_minipool - minipool created/destroyed events decoded from
--                                execution layer logs, mapping each minipool
--                                contract to its node operator.
-- ============================================================================

CREATE TABLE int_rocketpool_minipool_local ON CLUSTER '{cluster}' (
...
CREATE TABLE int_rocketpool_minipool ON CLUSTER '{cluster}' AS int_rocketpool_minipool_local ENGINE = Distributed(
    '{cluster}',
    currentDatabase(),
    int_rocketpool_minipool_local,
    cityHash64(event_name, minipool_address)
);
