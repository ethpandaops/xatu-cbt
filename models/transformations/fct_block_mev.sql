...
dependencies:
  ...
  - "{{transformation}}.int_block_mev_head"
---
INSERT INTO
...
orphaned_blocks AS (
    SELECT
        ...
        h.bid_date_time AS bid_date_time,
        ...
        'orphaned' AS `status`
    FROM `{{ index .dep "{{transformation}}" "int_block_mev_head" "database" }}`.`int_block_mev_head` AS h FINAL
