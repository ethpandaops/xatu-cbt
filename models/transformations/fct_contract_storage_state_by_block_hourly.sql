---
table: fct_contract_storage_state_by_block_hourly
type: incremental
interval:
  type: block
  max: 1000
...
tags:
  ...
  - contract
dependencies:
  - "{{transformation}}.int_contract_storage_state_by_block"
...
FROM (
    ...
    FROM (
        SELECT
            ...
            s.active_contracts,
            b.block_date_time
        FROM {{ index .dep "{{transformation}}" "int_contract_storage_state_by_block" "helpers" "from" }} AS s FINAL
