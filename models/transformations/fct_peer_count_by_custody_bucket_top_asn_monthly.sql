---
table: fct_peer_count_by_custody_bucket_top_asn_monthly
type: incremental
interval:
  type: slot
  max: 200000
schedules:
  forwardfill: "@every 6h"
  backfill: "@every 1m"
tags:
  - monthly
  - peerdas
...
-- Get all data within month boundaries with custody bucketing and ASN grouping
monthly_data AS (
    SELECT
