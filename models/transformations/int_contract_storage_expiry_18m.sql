---
table: int_contract_storage_expiry_18m
type: incremental
interval:
  type: block
  max: 1000
...
-- A contract expires at 18m if it was 12m-expired 6 months ago AND not reactivated before 18m expiry.
INSERT INTO
...
-- Get timestamps using GLOBAL IN to push filter to remote cluster
