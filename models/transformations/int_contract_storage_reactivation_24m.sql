---
table: int_contract_storage_reactivation_24m
type: incremental
interval:
  type: block
  max: 1000
...
---
-- 24-month reactivation: Detects when a contract is touched after its 24m expiry event.
INSERT INTO
...
-- Pre-filter 24m expiry table using IN clause
filtered_expiry AS (
    SELECT
        address,
        block_number,
