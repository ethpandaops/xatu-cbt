---
table: int_storage_slot_expiry_6m
type: incremental
interval:
  type: block
  max: 100000
...
-- A slot expires at 6m if it was 1m-expired 5 months ago AND not reactivated before 6m expiry.
-- Checks int_storage_slot_reactivation_1m instead of relying on propagated next_touch_block.
INSERT INTO
...
-- A reactivation invalidates if it happened before the new 6m expiry block
