---
table: int_storage_slot_reactivation_1m
type: incremental
interval:
  type: block
  max: 1000
...
---
-- 1-month reactivation: Detects when a slot is touched after its 1m expiry event.
...
filtered_expiry AS (
    ...
    FROM {{ index .dep "{{transformation}}" "int_storage_slot_expiry_1m" "helpers" "from" }}
