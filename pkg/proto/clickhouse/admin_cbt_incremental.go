...
// SQL query builder for admin_cbt_incremental
...
// BuildListAdminCbtIncrementalQuery constructs a parameterized SQL query from a ListAdminCbtIncrementalRequest
func BuildListAdminCbtIncrementalQuery(req *ListAdminCbtIncrementalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY database" + ", `table`" + ", position" + ", interval"
	}

	// Build column list
	columns := []string{"toUnixTimestamp64Micro(`updated_date_time`) AS `updated_date_time`", "database", "table", "position", "interval"}

	return BuildParameterizedQuery("admin_cbt_incremental", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetAdminCbtIncrementalQuery constructs a parameterized SQL query from a GetAdminCbtIncrementalRequest
func BuildGetAdminCbtIncrementalQuery(req *GetAdminCbtIncrementalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("admin_cbt_incremental", columns, qb, orderByClause, 1, 0, options...)
}
