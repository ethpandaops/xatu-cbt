...
func (x *StringFilter) GetRegex() string {
	if x, ok := x.GetFilter().(*StringFilter_Regex); ok {
		return x.Regex
	}
	return ""
}

func (x *StringFilter) GetNotRegex() string {
	if x, ok := x.GetFilter().(*StringFilter_NotRegex); ok {
		return x.NotRegex
	}
	return ""
}
...
type StringFilter_Regex struct {
	Regex string `protobuf:"bytes,8,opt,name=regex,proto3,oneof"` // Regular expression match
}

type StringFilter_NotRegex struct {
	NotRegex string `protobuf:"bytes,9,opt,name=not_regex,json=notRegex,proto3,oneof"` // Regular expression not match
}

type StringFilter_In struct {
	In *StringList `protobuf:"bytes,10,opt,name=in,proto3,oneof"` // In list of values
}

type StringFilter_NotIn struct {
	NotIn *StringList `protobuf:"bytes,11,opt,name=not_in,json=notIn,proto3,oneof"` // Not in list of values
}
...
func (*StringFilter_Regex) isStringFilter_Filter() {}

func (*StringFilter_NotRegex) isStringFilter_Filter() {}
...
type NullableStringFilter struct {
	...
	//	*NullableStringFilter_Regex
	//	*NullableStringFilter_NotRegex
...
func (x *NullableStringFilter) GetRegex() string {
	if x, ok := x.GetFilter().(*NullableStringFilter_Regex); ok {
		return x.Regex
	}
	return ""
}

func (x *NullableStringFilter) GetNotRegex() string {
	if x, ok := x.GetFilter().(*NullableStringFilter_NotRegex); ok {
		return x.NotRegex
	}
	return ""
}
...
type NullableStringFilter_Regex struct {
	Regex string `protobuf:"bytes,8,opt,name=regex,proto3,oneof"` // Regular expression match
}

type NullableStringFilter_NotRegex struct {
	NotRegex string `protobuf:"bytes,9,opt,name=not_regex,json=notRegex,proto3,oneof"` // Regular expression not match
}
...
type NullableStringFilter_IsNull struct {
	IsNull *emptypb.Empty `protobuf:"bytes,12,opt,name=is_null,json=isNull,proto3,oneof"` // IS NULL check
}

type NullableStringFilter_IsNotNull struct {
	IsNotNull *emptypb.Empty `protobuf:"bytes,13,opt,name=is_not_null,json=isNotNull,proto3,oneof"` // IS NOT NULL check
}
...
func (*NullableStringFilter_Regex) isNullableStringFilter_Filter() {}

func (*NullableStringFilter_NotRegex) isNullableStringFilter_Filter() {}
...
var file_common_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xd3, 0x02, 0x0a, 0x0c, 0x53,
	...
	,
	...
	0x74, 0x5f, 0x6e, 0x75, 0x6c, 0x6c, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x48, 0x00, 0x52, 0x09, 0x69, 0x73, 0x4e, 0x6f, 0x74, 0x4e, 0x75, 0x6c,
	0x6c, 0x42, 0x08, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x24, 0x0a, 0x0a, 0x53,
	...
	0x73, 0x2a, 0x1e, 0x0a, 0x09, 0x53, 0x6f, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x07,
...
func file_common_proto_init() {
	...
	file_common_proto_msgTypes[17].OneofWrappers = []any{
		...
		(*NullableStringFilter_Regex)(nil),
		(*NullableStringFilter_NotRegex)(nil),
