...
// SQL query builder for dim_block_blob_submitter
...
// BuildListDimBlockBlobSubmitterQuery constructs a parameterized SQL query from a ListDimBlockBlobSubmitterRequest
func BuildListDimBlockBlobSubmitterQuery(req *ListDimBlockBlobSubmitterRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetDimBlockBlobSubmitterQuery constructs a parameterized SQL query from a GetDimBlockBlobSubmitterRequest
func BuildGetDimBlockBlobSubmitterQuery(req *GetDimBlockBlobSubmitterRequest, options ...QueryOption) (SQLQuery, error) {
