...
// SQL query builder for dim_block_canonical
...
// BuildListDimBlockCanonicalQuery constructs a parameterized SQL query from a ListDimBlockCanonicalRequest
func BuildListDimBlockCanonicalQuery(req *ListDimBlockCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.ExecutionBlockHash != nil {
		...
		case *StringFilter_Eq:
			qb.AddCondition("execution_block_hash", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("execution_block_hash", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("execution_block_hash", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("execution_block_hash", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("execution_block_hash", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("execution_block_hash", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("execution_block_hash", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("execution_block_hash", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("execution_block_hash", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: beacon_block_version
	if req.BeaconBlockVersion != nil {
		switch filter := req.BeaconBlockVersion.Filter.(type) {
		case *NullableStringFilter_Eq:
			qb.AddCondition("beacon_block_version", "=", filter.Eq)
		case *NullableStringFilter_Ne:
			qb.AddCondition("beacon_block_version", "!=", filter.Ne)
		case *NullableStringFilter_Contains:
			qb.AddLikeCondition("beacon_block_version", "%" + filter.Contains + "%")
		case *NullableStringFilter_StartsWith:
			qb.AddLikeCondition("beacon_block_version", filter.StartsWith + "%")
		case *NullableStringFilter_EndsWith:
			qb.AddLikeCondition("beacon_block_version", "%" + filter.EndsWith)
		case *NullableStringFilter_Like:
			qb.AddLikeCondition("beacon_block_version", filter.Like)
		case *NullableStringFilter_NotLike:
			qb.AddNotLikeCondition("beacon_block_version", filter.NotLike)
		case *NullableStringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("beacon_block_version", StringSliceToInterface(filter.In.Values))
			}
		case *NullableStringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("beacon_block_version", StringSliceToInterface(filter.NotIn.Values))
			}
		case *NullableStringFilter_IsNull:
			qb.AddIsNullCondition("beacon_block_version")
		case *NullableStringFilter_IsNotNull:
			qb.AddIsNotNullCondition("beacon_block_version")
		default:
			// Unsupported filter type
		}
	}
	...
	// Add filter for column: beacon_parent_root
	if req.BeaconParentRoot != nil {
		switch filter := req.BeaconParentRoot.Filter.(type) {
		case *NullableStringFilter_Eq:
			qb.AddCondition("beacon_parent_root", "=", filter.Eq)
		case *NullableStringFilter_Ne:
			qb.AddCondition("beacon_parent_root", "!=", filter.Ne)
		case *NullableStringFilter_Contains:
			qb.AddLikeCondition("beacon_parent_root", "%" + filter.Contains + "%")
		case *NullableStringFilter_StartsWith:
			qb.AddLikeCondition("beacon_parent_root", filter.StartsWith + "%")
		case *NullableStringFilter_EndsWith:
			qb.AddLikeCondition("beacon_parent_root", "%" + filter.EndsWith)
		case *NullableStringFilter_Like:
			qb.AddLikeCondition("beacon_parent_root", filter.Like)
		case *NullableStringFilter_NotLike:
			qb.AddNotLikeCondition("beacon_parent_root", filter.NotLike)
		case *NullableStringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("beacon_parent_root", StringSliceToInterface(filter.In.Values))
			}
		case *NullableStringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("beacon_parent_root", StringSliceToInterface(filter.NotIn.Values))
			}
		case *NullableStringFilter_IsNull:
			qb.AddIsNullCondition("beacon_parent_root")
		case *NullableStringFilter_IsNotNull:
			qb.AddIsNotNullCondition("beacon_parent_root")
		default:
			// Unsupported filter type
		}
	}

	// Add filter for column: beacon_state_root
	if req.BeaconStateRoot != nil {
		switch filter := req.BeaconStateRoot.Filter.(type) {
		case *NullableStringFilter_Eq:
			qb.AddCondition("beacon_state_root", "=", filter.Eq)
		case *NullableStringFilter_Ne:
			qb.AddCondition("beacon_state_root", "!=", filter.Ne)
		case *NullableStringFilter_Contains:
			qb.AddLikeCondition("beacon_state_root", "%" + filter.Contains + "%")
		case *NullableStringFilter_StartsWith:
			qb.AddLikeCondition("beacon_state_root", filter.StartsWith + "%")
		case *NullableStringFilter_EndsWith:
			qb.AddLikeCondition("beacon_state_root", "%" + filter.EndsWith)
		case *NullableStringFilter_Like:
			qb.AddLikeCondition("beacon_state_root", filter.Like)
		case *NullableStringFilter_NotLike:
			qb.AddNotLikeCondition("beacon_state_root", filter.NotLike)
		case *NullableStringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("beacon_state_root", StringSliceToInterface(filter.In.Values))
			}
		case *NullableStringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("beacon_state_root", StringSliceToInterface(filter.NotIn.Values))
			}
		case *NullableStringFilter_IsNull:
			qb.AddIsNullCondition("beacon_state_root")
		case *NullableStringFilter_IsNotNull:
			qb.AddIsNotNullCondition("beacon_state_root")
		default:
			// Unsupported filter type
		}
	}
...
// BuildGetDimBlockCanonicalQuery constructs a parameterized SQL query from a GetDimBlockCanonicalRequest
func BuildGetDimBlockCanonicalQuery(req *GetDimBlockCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
