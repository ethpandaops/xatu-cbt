...
var file_dim_node_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa8, 0x03, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74,
	...
	0x65, 0x72, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x67, 0x72, 0x6f, 0x75,
...
var file_dim_node_proto_goTypes = []any{
	...
	(*MapStringStringFilter)(nil),  // 9: cbt.MapStringStringFilter
...
var file_dim_node_proto_depIdxs = []int32{
	...
	9,  // 5: cbt.ListDimNodeRequest.attributes:type_name -> cbt.MapStringStringFilter
	10, // 6: cbt.ListDimNodeRequest.source:type_name -> cbt.StringFilter
	0,  // 7: cbt.ListDimNodeResponse.dim_node:type_name -> cbt.DimNode
	0,  // 8: cbt.GetDimNodeResponse.item:type_name -> cbt.DimNode
	1,  // 9: cbt.DimNodeService.List:input_type -> cbt.ListDimNodeRequest
	3,  // 10: cbt.DimNodeService.Get:input_type -> cbt.GetDimNodeRequest
	2,  // 11: cbt.DimNodeService.List:output_type -> cbt.ListDimNodeResponse
	4,  // 12: cbt.DimNodeService.Get:output_type -> cbt.GetDimNodeResponse
