...
// SQL query builder for fct_address_storage_slot_chunked_10000
...
// BuildListFctAddressStorageSlotChunked10000Query constructs a parameterized SQL query from a ListFctAddressStorageSlotChunked10000Request
func BuildListFctAddressStorageSlotChunked10000Query(req *ListFctAddressStorageSlotChunked10000Request, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: first_accessed_slots
	if req.FirstAccessedSlots != nil {
		switch filter := req.FirstAccessedSlots.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("first_accessed_slots", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("first_accessed_slots", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("first_accessed_slots", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("first_accessed_slots", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("first_accessed_slots", ">", filter.Gt)
		case *UInt32Filter_Gte:
		...
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("first_accessed_slots", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: last_accessed_slots
	if req.LastAccessedSlots != nil {
		switch filter := req.LastAccessedSlots.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("last_accessed_slots", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("last_accessed_slots", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("last_accessed_slots", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("last_accessed_slots", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("last_accessed_slots", ">", filter.Gt)
		case *UInt32Filter_Gte:
		...
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("last_accessed_slots", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "chunk_start_block_number", "first_accessed_slots", "last_accessed_slots"}
...
// BuildGetFctAddressStorageSlotChunked10000Query constructs a parameterized SQL query from a GetFctAddressStorageSlotChunked10000Request
func BuildGetFctAddressStorageSlotChunked10000Query(req *GetFctAddressStorageSlotChunked10000Request, options ...QueryOption) (SQLQuery, error) {
