...
// SQL query builder for fct_attestation_correctness
...
// BuildListFctAttestationCorrectnessQuery constructs a parameterized SQL query from a ListFctAttestationCorrectnessRequest
func BuildListFctAttestationCorrectnessQuery(req *ListFctAttestationCorrectnessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_correctness", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationCorrectnessQuery constructs a parameterized SQL query from a GetFctAttestationCorrectnessRequest
func BuildGetFctAttestationCorrectnessQuery(req *GetFctAttestationCorrectnessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_correctness", columns, qb, orderByClause, 1, 0, options...)
}
