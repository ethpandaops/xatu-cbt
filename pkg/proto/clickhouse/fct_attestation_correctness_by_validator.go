...
// SQL query builder for fct_attestation_correctness_by_validator
...
// BuildListFctAttestationCorrectnessByValidatorQuery constructs a parameterized SQL query from a ListFctAttestationCorrectnessByValidatorRequest
func BuildListFctAttestationCorrectnessByValidatorQuery(req *ListFctAttestationCorrectnessByValidatorRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: slot_distance
	if req.SlotDistance != nil {
		switch filter := req.SlotDistance.Filter.(type) {
		case *NullableUInt32Filter_Eq:
			qb.AddCondition("slot_distance", "=", filter.Eq)
		case *NullableUInt32Filter_Ne:
			qb.AddCondition("slot_distance", "!=", filter.Ne)
		case *NullableUInt32Filter_Lt:
			qb.AddCondition("slot_distance", "<", filter.Lt)
		case *NullableUInt32Filter_Lte:
			qb.AddCondition("slot_distance", "<=", filter.Lte)
		case *NullableUInt32Filter_Gt:
			qb.AddCondition("slot_distance", ">", filter.Gt)
		...
		case *NullableUInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("slot_distance", UInt32SliceToInterface(filter.NotIn.Values))
			}
		case *NullableUInt32Filter_IsNull:
			qb.AddIsNullCondition("slot_distance")
		case *NullableUInt32Filter_IsNotNull:
			qb.AddIsNotNullCondition("slot_distance")
		default:
			// Unsupported filter type
		}
	}
	...
	if req.PropagationDistance != nil {
		...
		case *NullableUInt32Filter_IsNull:
			qb.AddIsNullCondition("propagation_distance")
		case *NullableUInt32Filter_IsNotNull:
			qb.AddIsNotNullCondition("propagation_distance")
		default:
			// Unsupported filter type
		}
	}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "attesting_validator_index", "block_root", "slot_distance", "propagation_distance", "inclusion_distance", "status"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "attesting_validator_index", "block_root", "slot_distance", "propagation_distance", "inclusion_distance", "status"}

	return BuildParameterizedQuery("fct_attestation_correctness_by_validator", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationCorrectnessByValidatorQuery constructs a parameterized SQL query from a GetFctAttestationCorrectnessByValidatorRequest
func BuildGetFctAttestationCorrectnessByValidatorQuery(req *GetFctAttestationCorrectnessByValidatorRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_correctness_by_validator", columns, qb, orderByClause, 1, 0, options...)
}
