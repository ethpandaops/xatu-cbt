...
// SQL query builder for fct_attestation_correctness_by_validator_canonical
...
// BuildListFctAttestationCorrectnessByValidatorCanonicalQuery constructs a parameterized SQL query from a ListFctAttestationCorrectnessByValidatorCanonicalRequest
func BuildListFctAttestationCorrectnessByValidatorCanonicalQuery(req *ListFctAttestationCorrectnessByValidatorCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "attesting_validator_index", "block_root", "slot_distance", "inclusion_distance", "status"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "attesting_validator_index", "block_root", "slot_distance", "inclusion_distance", "status"}
...
func BuildGetFctAttestationCorrectnessByValidatorCanonicalQuery(req *GetFctAttestationCorrectnessByValidatorCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
