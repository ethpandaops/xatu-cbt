...
// SQL query builder for fct_attestation_correctness_by_validator_head
...
// BuildListFctAttestationCorrectnessByValidatorHeadQuery constructs a parameterized SQL query from a ListFctAttestationCorrectnessByValidatorHeadRequest
func BuildListFctAttestationCorrectnessByValidatorHeadQuery(req *ListFctAttestationCorrectnessByValidatorHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "attesting_validator_index", "block_root", "slot_distance", "propagation_distance"}
	...
	return BuildParameterizedQuery("fct_attestation_correctness_by_validator_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetFctAttestationCorrectnessByValidatorHeadQuery constructs a parameterized SQL query from a GetFctAttestationCorrectnessByValidatorHeadRequest
func BuildGetFctAttestationCorrectnessByValidatorHeadQuery(req *GetFctAttestationCorrectnessByValidatorHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_correctness_by_validator_head", qb, orderByClause, 1, 0, options...), nil
}
