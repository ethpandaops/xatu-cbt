...
// SQL query builder for fct_attestation_correctness_canonical
...
// BuildListFctAttestationCorrectnessCanonicalQuery constructs a parameterized SQL query from a ListFctAttestationCorrectnessCanonicalRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctAttestationCorrectnessCanonicalQuery(req *ListFctAttestationCorrectnessCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_correctness_canonical", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetFctAttestationCorrectnessCanonicalQuery constructs a parameterized SQL query from a GetFctAttestationCorrectnessCanonicalRequest
func BuildGetFctAttestationCorrectnessCanonicalQuery(req *GetFctAttestationCorrectnessCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_correctness_canonical", qb, orderByClause, 1, 0, options...), nil
}
