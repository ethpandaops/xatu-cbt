...
// SQL query builder for fct_attestation_first_seen_by_node
...
// BuildListFctAttestationFirstSeenByNodeQuery constructs a parameterized SQL query from a ListFctAttestationFirstSeenByNodeRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctAttestationFirstSeenByNodeQuery(req *ListFctAttestationFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "attestation_count", "avg_seen_slot_start_diff", "min_seen_slot_start_diff", "max_seen_slot_start_diff", "block_root", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_consensus_version", "meta_consensus_implementation"}
	...
	return BuildParameterizedQuery("fct_attestation_first_seen_by_node", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationFirstSeenByNodeQuery constructs a parameterized SQL query from a GetFctAttestationFirstSeenByNodeRequest
func BuildGetFctAttestationFirstSeenByNodeQuery(req *GetFctAttestationFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_first_seen_by_node", columns, qb, orderByClause, 1, 0, options...)
}
