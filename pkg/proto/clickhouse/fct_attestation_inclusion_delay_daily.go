...
// SQL query builder for fct_attestation_inclusion_delay_daily
...
// BuildListFctAttestationInclusionDelayDailyQuery constructs a parameterized SQL query from a ListFctAttestationInclusionDelayDailyRequest
func BuildListFctAttestationInclusionDelayDailyQuery(req *ListFctAttestationInclusionDelayDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "slot_count", "avg_inclusion_delay", "min_inclusion_delay", "max_inclusion_delay", "p05_inclusion_delay", "p50_inclusion_delay", "p95_inclusion_delay", "stddev_inclusion_delay", "upper_band_inclusion_delay", "lower_band_inclusion_delay", "moving_avg_inclusion_delay"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "slot_count", "avg_inclusion_delay", "min_inclusion_delay", "max_inclusion_delay", "p05_inclusion_delay", "p50_inclusion_delay", "p95_inclusion_delay", "stddev_inclusion_delay", "upper_band_inclusion_delay", "lower_band_inclusion_delay", "moving_avg_inclusion_delay"}

	return BuildParameterizedQuery("fct_attestation_inclusion_delay_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationInclusionDelayDailyQuery constructs a parameterized SQL query from a GetFctAttestationInclusionDelayDailyRequest
func BuildGetFctAttestationInclusionDelayDailyQuery(req *GetFctAttestationInclusionDelayDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_inclusion_delay_daily", columns, qb, orderByClause, 1, 0, options...)
}
