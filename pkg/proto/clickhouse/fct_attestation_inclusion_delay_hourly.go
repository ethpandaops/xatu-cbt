...
// SQL query builder for fct_attestation_inclusion_delay_hourly
...
// BuildListFctAttestationInclusionDelayHourlyQuery constructs a parameterized SQL query from a ListFctAttestationInclusionDelayHourlyRequest
func BuildListFctAttestationInclusionDelayHourlyQuery(req *ListFctAttestationInclusionDelayHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: avg_inclusion_delay

	// Add filter for column: min_inclusion_delay

	// Add filter for column: max_inclusion_delay

	// Add filter for column: p05_inclusion_delay

	// Add filter for column: p50_inclusion_delay

	// Add filter for column: p95_inclusion_delay

	// Add filter for column: stddev_inclusion_delay

	// Add filter for column: upper_band_inclusion_delay

	// Add filter for column: lower_band_inclusion_delay

	// Add filter for column: moving_avg_inclusion_delay
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "slot_count", "avg_inclusion_delay", "min_inclusion_delay", "max_inclusion_delay", "p05_inclusion_delay", "p50_inclusion_delay", "p95_inclusion_delay", "stddev_inclusion_delay", "upper_band_inclusion_delay", "lower_band_inclusion_delay", "moving_avg_inclusion_delay"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "slot_count", "avg_inclusion_delay", "min_inclusion_delay", "max_inclusion_delay", "p05_inclusion_delay", "p50_inclusion_delay", "p95_inclusion_delay", "stddev_inclusion_delay", "upper_band_inclusion_delay", "lower_band_inclusion_delay", "moving_avg_inclusion_delay"}

	return BuildParameterizedQuery("fct_attestation_inclusion_delay_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationInclusionDelayHourlyQuery constructs a parameterized SQL query from a GetFctAttestationInclusionDelayHourlyRequest
func BuildGetFctAttestationInclusionDelayHourlyQuery(req *GetFctAttestationInclusionDelayHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_inclusion_delay_hourly", columns, qb, orderByClause, 1, 0, options...)
}
