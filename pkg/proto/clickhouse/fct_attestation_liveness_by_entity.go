...
// SQL query builder for fct_attestation_liveness_by_entity
...
func BuildListFctAttestationLivenessByEntityQuery(req *ListFctAttestationLivenessByEntityRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_liveness_by_entity", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationLivenessByEntityQuery constructs a parameterized SQL query from a GetFctAttestationLivenessByEntityRequest
func BuildGetFctAttestationLivenessByEntityQuery(req *GetFctAttestationLivenessByEntityRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_liveness_by_entity", columns, qb, orderByClause, 1, 0, options...)
}
