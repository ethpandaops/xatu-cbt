...
// SQL query builder for fct_attestation_liveness_by_entity_day_head
...
// BuildListFctAttestationLivenessByEntityDayHeadQuery constructs a parameterized SQL query from a ListFctAttestationLivenessByEntityDayHeadRequest
func BuildListFctAttestationLivenessByEntityDayHeadQuery(req *ListFctAttestationLivenessByEntityDayHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_liveness_by_entity_day_head", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationLivenessByEntityDayHeadQuery constructs a parameterized SQL query from a GetFctAttestationLivenessByEntityDayHeadRequest
func BuildGetFctAttestationLivenessByEntityDayHeadQuery(req *GetFctAttestationLivenessByEntityDayHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_liveness_by_entity_day_head", columns, qb, orderByClause, 1, 0, options...)
}
