...
// SQL query builder for fct_attestation_liveness_by_entity_epoch_head
...
// BuildListFctAttestationLivenessByEntityEpochHeadQuery constructs a parameterized SQL query from a ListFctAttestationLivenessByEntityEpochHeadRequest
//
// Available projections:
//   - p_by_epoch (primary key: epoch)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctAttestationLivenessByEntityEpochHeadQuery(req *ListFctAttestationLivenessByEntityEpochHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_liveness_by_entity_epoch_head", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationLivenessByEntityEpochHeadQuery constructs a parameterized SQL query from a GetFctAttestationLivenessByEntityEpochHeadRequest
func BuildGetFctAttestationLivenessByEntityEpochHeadQuery(req *GetFctAttestationLivenessByEntityEpochHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_liveness_by_entity_epoch_head", columns, qb, orderByClause, 1, 0, options...)
}
