...
// SQL query builder for fct_attestation_liveness_by_entity_head
...
// BuildListFctAttestationLivenessByEntityHeadQuery constructs a parameterized SQL query from a ListFctAttestationLivenessByEntityHeadRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctAttestationLivenessByEntityHeadQuery(req *ListFctAttestationLivenessByEntityHeadRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetFctAttestationLivenessByEntityHeadQuery constructs a parameterized SQL query from a GetFctAttestationLivenessByEntityHeadRequest
func BuildGetFctAttestationLivenessByEntityHeadQuery(req *GetFctAttestationLivenessByEntityHeadRequest, options ...QueryOption) (SQLQuery, error) {
