...
// SQL query builder for fct_attestation_participation_rate_daily
...
// BuildListFctAttestationParticipationRateDailyQuery constructs a parameterized SQL query from a ListFctAttestationParticipationRateDailyRequest
func BuildListFctAttestationParticipationRateDailyQuery(req *ListFctAttestationParticipationRateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "slot_count", "avg_participation_rate", "min_participation_rate", "max_participation_rate", "p05_participation_rate", "p50_participation_rate", "p95_participation_rate", "stddev_participation_rate", "upper_band_participation_rate", "lower_band_participation_rate", "moving_avg_participation_rate"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "slot_count", "avg_participation_rate", "min_participation_rate", "max_participation_rate", "p05_participation_rate", "p50_participation_rate", "p95_participation_rate", "stddev_participation_rate", "upper_band_participation_rate", "lower_band_participation_rate", "moving_avg_participation_rate"}

	return BuildParameterizedQuery("fct_attestation_participation_rate_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctAttestationParticipationRateDailyQuery constructs a parameterized SQL query from a GetFctAttestationParticipationRateDailyRequest
func BuildGetFctAttestationParticipationRateDailyQuery(req *GetFctAttestationParticipationRateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_attestation_participation_rate_daily", columns, qb, orderByClause, 1, 0, options...)
}
