...
// SQL query builder for fct_blob_count_by_daily
...
// BuildListFctBlobCountByDailyQuery constructs a parameterized SQL query from a ListFctBlobCountByDailyRequest
func BuildListFctBlobCountByDailyQuery(req *ListFctBlobCountByDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_blob_count_by_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlobCountByDailyQuery constructs a parameterized SQL query from a GetFctBlobCountByDailyRequest
func BuildGetFctBlobCountByDailyQuery(req *GetFctBlobCountByDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_blob_count_by_daily", columns, qb, orderByClause, 1, 0, options...)
}
