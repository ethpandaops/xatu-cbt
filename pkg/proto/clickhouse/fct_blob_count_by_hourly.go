...
// SQL query builder for fct_blob_count_by_hourly
...
// BuildListFctBlobCountByHourlyQuery constructs a parameterized SQL query from a ListFctBlobCountByHourlyRequest
func BuildListFctBlobCountByHourlyQuery(req *ListFctBlobCountByHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_blob_count_by_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlobCountByHourlyQuery constructs a parameterized SQL query from a GetFctBlobCountByHourlyRequest
func BuildGetFctBlobCountByHourlyQuery(req *GetFctBlobCountByHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_blob_count_by_hourly", columns, qb, orderByClause, 1, 0, options...)
}
