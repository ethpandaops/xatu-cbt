...
// SQL query builder for fct_block_blob_count
...
// BuildListFctBlockBlobCountQuery constructs a parameterized SQL query from a ListFctBlockBlobCountRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockBlobCountQuery(req *ListFctBlockBlobCountRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "blob_count", "status"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "block_root", "blob_count", "status"}
...
func BuildGetFctBlockBlobCountQuery(req *GetFctBlockBlobCountRequest, options ...QueryOption) (SQLQuery, error) {
