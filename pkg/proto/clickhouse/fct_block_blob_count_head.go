...
// SQL query builder for fct_block_blob_count_head
...
// BuildListFctBlockBlobCountHeadQuery constructs a parameterized SQL query from a ListFctBlockBlobCountHeadRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockBlobCountHeadQuery(req *ListFctBlockBlobCountHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_blob_count_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetFctBlockBlobCountHeadQuery constructs a parameterized SQL query from a GetFctBlockBlobCountHeadRequest
func BuildGetFctBlockBlobCountHeadQuery(req *GetFctBlockBlobCountHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_blob_count_head", qb, orderByClause, 1, 0, options...), nil
}
