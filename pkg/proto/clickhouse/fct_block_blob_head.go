...
// SQL query builder for fct_block_blob_head
...
// BuildListFctBlockBlobHeadQuery constructs a parameterized SQL query from a ListFctBlockBlobHeadRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockBlobHeadQuery(req *ListFctBlockBlobHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "blob_index", "versioned_hash", "kzg_commitment"}
		...
		orderByClause = " ORDER BY slot_start_date_time" + ", block_root" + ", blob_index"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "block_root", "blob_index", "versioned_hash", "kzg_commitment"}

	return BuildParameterizedQuery("fct_block_blob_head", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockBlobHeadQuery constructs a parameterized SQL query from a GetFctBlockBlobHeadRequest
func BuildGetFctBlockBlobHeadQuery(req *GetFctBlockBlobHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_blob_head", columns, qb, orderByClause, 1, 0, options...)
}
