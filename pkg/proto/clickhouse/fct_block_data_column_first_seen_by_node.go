...
// SQL query builder for fct_block_data_column_first_seen_by_node
...
// BuildListFctBlockDataColumnFirstSeenByNodeQuery constructs a parameterized SQL query from a ListFctBlockDataColumnFirstSeenByNodeRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockDataColumnFirstSeenByNodeQuery(req *ListFctBlockDataColumnFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_data_column_first_seen_by_node", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockDataColumnFirstSeenByNodeQuery constructs a parameterized SQL query from a GetFctBlockDataColumnFirstSeenByNodeRequest
func BuildGetFctBlockDataColumnFirstSeenByNodeQuery(req *GetFctBlockDataColumnFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_data_column_first_seen_by_node", columns, qb, orderByClause, 1, 0, options...)
}
