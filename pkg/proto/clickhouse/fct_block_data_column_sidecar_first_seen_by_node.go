...
// SQL query builder for fct_block_data_column_sidecar_first_seen_by_node
...
// BuildListFctBlockDataColumnSidecarFirstSeenByNodeQuery constructs a parameterized SQL query from a ListFctBlockDataColumnSidecarFirstSeenByNodeRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockDataColumnSidecarFirstSeenByNodeQuery(req *ListFctBlockDataColumnSidecarFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetFctBlockDataColumnSidecarFirstSeenByNodeQuery constructs a parameterized SQL query from a GetFctBlockDataColumnSidecarFirstSeenByNodeRequest
func BuildGetFctBlockDataColumnSidecarFirstSeenByNodeQuery(req *GetFctBlockDataColumnSidecarFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
