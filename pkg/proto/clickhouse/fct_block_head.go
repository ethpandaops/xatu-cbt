...
// SQL query builder for fct_block_head
...
// BuildListFctBlockHeadQuery constructs a parameterized SQL query from a ListFctBlockHeadRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockHeadQuery(req *ListFctBlockHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetFctBlockHeadQuery constructs a parameterized SQL query from a GetFctBlockHeadRequest
func BuildGetFctBlockHeadQuery(req *GetFctBlockHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_head", qb, orderByClause, 1, 0, options...), nil
}
