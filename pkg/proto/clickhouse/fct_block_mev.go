...
// SQL query builder for fct_block_mev
...
// BuildListFctBlockMevQuery constructs a parameterized SQL query from a ListFctBlockMevRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockMevQuery(req *ListFctBlockMevRequest, options ...QueryOption) (SQLQuery, error) {
...
func BuildGetFctBlockMevQuery(req *GetFctBlockMevRequest, options ...QueryOption) (SQLQuery, error) {
