...
// SQL query builder for fct_block_payload_first_seen_by_node
...
// BuildListFctBlockPayloadFirstSeenByNodeQuery constructs a parameterized SQL query from a ListFctBlockPayloadFirstSeenByNodeRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctBlockPayloadFirstSeenByNodeQuery(req *ListFctBlockPayloadFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "source", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "seen_slot_start_diff", "block_root", "block_hash", "builder_index", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_consensus_version", "meta_consensus_implementation"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "source", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "seen_slot_start_diff", "block_root", "NULLIF(`block_hash`, repeat('\x00', 66)) AS `block_hash`", "builder_index", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_consensus_version", "meta_consensus_implementation"}

	return BuildParameterizedQuery("fct_block_payload_first_seen_by_node", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockPayloadFirstSeenByNodeQuery constructs a parameterized SQL query from a GetFctBlockPayloadFirstSeenByNodeRequest
func BuildGetFctBlockPayloadFirstSeenByNodeQuery(req *GetFctBlockPayloadFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_payload_first_seen_by_node", columns, qb, orderByClause, 1, 0, options...)
}
