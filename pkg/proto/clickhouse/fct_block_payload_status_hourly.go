...
// SQL query builder for fct_block_payload_status_hourly
...
// BuildListFctBlockPayloadStatusHourlyQuery constructs a parameterized SQL query from a ListFctBlockPayloadStatusHourlyRequest
func BuildListFctBlockPayloadStatusHourlyQuery(req *ListFctBlockPayloadStatusHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_payload_status_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockPayloadStatusHourlyQuery constructs a parameterized SQL query from a GetFctBlockPayloadStatusHourlyRequest
func BuildGetFctBlockPayloadStatusHourlyQuery(req *GetFctBlockPayloadStatusHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_payload_status_hourly", columns, qb, orderByClause, 1, 0, options...)
}
