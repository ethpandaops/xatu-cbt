...
// SQL query builder for fct_block_proposal_status_daily
...
// BuildListFctBlockProposalStatusDailyQuery constructs a parameterized SQL query from a ListFctBlockProposalStatusDailyRequest
func BuildListFctBlockProposalStatusDailyQuery(req *ListFctBlockProposalStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "status", "slot_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", status"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "status", "slot_count"}

	return BuildParameterizedQuery("fct_block_proposal_status_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockProposalStatusDailyQuery constructs a parameterized SQL query from a GetFctBlockProposalStatusDailyRequest
func BuildGetFctBlockProposalStatusDailyQuery(req *GetFctBlockProposalStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_proposal_status_daily", columns, qb, orderByClause, 1, 0, options...)
}
