...
// SQL query builder for fct_block_proposal_status_hourly
...
// BuildListFctBlockProposalStatusHourlyQuery constructs a parameterized SQL query from a ListFctBlockProposalStatusHourlyRequest
func BuildListFctBlockProposalStatusHourlyQuery(req *ListFctBlockProposalStatusHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "status", "slot_count"}
		...
		orderByClause = " ORDER BY hour_start_date_time" + ", status"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "status", "slot_count"}

	return BuildParameterizedQuery("fct_block_proposal_status_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockProposalStatusHourlyQuery constructs a parameterized SQL query from a GetFctBlockProposalStatusHourlyRequest
func BuildGetFctBlockProposalStatusHourlyQuery(req *GetFctBlockProposalStatusHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_proposal_status_hourly", columns, qb, orderByClause, 1, 0, options...)
}
