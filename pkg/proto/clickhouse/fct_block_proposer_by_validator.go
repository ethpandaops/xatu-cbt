...
// SQL query builder for fct_block_proposer_by_validator
...
// BuildListFctBlockProposerByValidatorQuery constructs a parameterized SQL query from a ListFctBlockProposerByValidatorRequest
func BuildListFctBlockProposerByValidatorQuery(req *ListFctBlockProposerByValidatorRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "validator_index", "pubkey", "block_root", "status"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "validator_index", "pubkey", "block_root", "status"}

	return BuildParameterizedQuery("fct_block_proposer_by_validator", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctBlockProposerByValidatorQuery constructs a parameterized SQL query from a GetFctBlockProposerByValidatorRequest
func BuildGetFctBlockProposerByValidatorQuery(req *GetFctBlockProposerByValidatorRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_block_proposer_by_validator", columns, qb, orderByClause, 1, 0, options...)
}
