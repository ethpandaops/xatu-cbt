...
// SQL query builder for fct_contract_storage_state_by_address_hourly
...
// BuildListFctContractStorageStateByAddressHourlyQuery constructs a parameterized SQL query from a ListFctContractStorageStateByAddressHourlyRequest
func BuildListFctContractStorageStateByAddressHourlyQuery(req *ListFctContractStorageStateByAddressHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "address", "hour_start_date_time", "active_slots", "effective_bytes"}
		...
		orderByClause = " ORDER BY address" + ", hour_start_date_time"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "address", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("fct_contract_storage_state_by_address_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctContractStorageStateByAddressHourlyQuery constructs a parameterized SQL query from a GetFctContractStorageStateByAddressHourlyRequest
func BuildGetFctContractStorageStateByAddressHourlyQuery(req *GetFctContractStorageStateByAddressHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_contract_storage_state_by_address_hourly", columns, qb, orderByClause, 1, 0, options...)
}
