...
// SQL query builder for fct_contract_storage_state_with_expiry_by_address_daily
...
// BuildListFctContractStorageStateWithExpiryByAddressDailyQuery constructs a parameterized SQL query from a ListFctContractStorageStateWithExpiryByAddressDailyRequest
func BuildListFctContractStorageStateWithExpiryByAddressDailyQuery(req *ListFctContractStorageStateWithExpiryByAddressDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "address", "day_start_date", "expiry_policy", "active_slots", "effective_bytes"}
		...
		orderByClause = " ORDER BY address" + ", expiry_policy" + ", day_start_date"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "address", "toString(`day_start_date`) AS `day_start_date`", "expiry_policy", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("fct_contract_storage_state_with_expiry_by_address_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctContractStorageStateWithExpiryByAddressDailyQuery constructs a parameterized SQL query from a GetFctContractStorageStateWithExpiryByAddressDailyRequest
func BuildGetFctContractStorageStateWithExpiryByAddressDailyQuery(req *GetFctContractStorageStateWithExpiryByAddressDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_contract_storage_state_with_expiry_by_address_daily", columns, qb, orderByClause, 1, 0, options...)
}
