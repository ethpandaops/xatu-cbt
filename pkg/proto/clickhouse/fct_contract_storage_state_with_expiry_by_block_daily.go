...
// SQL query builder for fct_contract_storage_state_with_expiry_by_block_daily
...
// BuildListFctContractStorageStateWithExpiryByBlockDailyQuery constructs a parameterized SQL query from a ListFctContractStorageStateWithExpiryByBlockDailyRequest
func BuildListFctContractStorageStateWithExpiryByBlockDailyQuery(req *ListFctContractStorageStateWithExpiryByBlockDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "expiry_policy", "active_slots", "effective_bytes", "active_contracts"}
		...
		orderByClause = " ORDER BY expiry_policy" + ", day_start_date"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "expiry_policy", "active_slots", "effective_bytes", "active_contracts"}

	return BuildParameterizedQuery("fct_contract_storage_state_with_expiry_by_block_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctContractStorageStateWithExpiryByBlockDailyQuery constructs a parameterized SQL query from a GetFctContractStorageStateWithExpiryByBlockDailyRequest
func BuildGetFctContractStorageStateWithExpiryByBlockDailyQuery(req *GetFctContractStorageStateWithExpiryByBlockDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_contract_storage_state_with_expiry_by_block_daily", columns, qb, orderByClause, 1, 0, options...)
}
