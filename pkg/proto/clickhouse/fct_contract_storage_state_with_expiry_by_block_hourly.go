...
// SQL query builder for fct_contract_storage_state_with_expiry_by_block_hourly
...
// BuildListFctContractStorageStateWithExpiryByBlockHourlyQuery constructs a parameterized SQL query from a ListFctContractStorageStateWithExpiryByBlockHourlyRequest
func BuildListFctContractStorageStateWithExpiryByBlockHourlyQuery(req *ListFctContractStorageStateWithExpiryByBlockHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "expiry_policy", "active_slots", "effective_bytes", "active_contracts"}
		...
		orderByClause = " ORDER BY expiry_policy" + ", hour_start_date_time"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "expiry_policy", "active_slots", "effective_bytes", "active_contracts"}

	return BuildParameterizedQuery("fct_contract_storage_state_with_expiry_by_block_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctContractStorageStateWithExpiryByBlockHourlyQuery constructs a parameterized SQL query from a GetFctContractStorageStateWithExpiryByBlockHourlyRequest
func BuildGetFctContractStorageStateWithExpiryByBlockHourlyQuery(req *GetFctContractStorageStateWithExpiryByBlockHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_contract_storage_state_with_expiry_by_block_hourly", columns, qb, orderByClause, 1, 0, options...)
}
