...
// SQL query builder for fct_data_column_availability_by_epoch
...
// BuildListFctDataColumnAvailabilityByEpochQuery constructs a parameterized SQL query from a ListFctDataColumnAvailabilityByEpochRequest
//
// Available projections:
//   - p_by_epoch_column (primary key: epoch)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctDataColumnAvailabilityByEpochQuery(req *ListFctDataColumnAvailabilityByEpochRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetFctDataColumnAvailabilityByEpochQuery constructs a parameterized SQL query from a GetFctDataColumnAvailabilityByEpochRequest
func BuildGetFctDataColumnAvailabilityByEpochQuery(req *GetFctDataColumnAvailabilityByEpochRequest, options ...QueryOption) (SQLQuery, error) {
