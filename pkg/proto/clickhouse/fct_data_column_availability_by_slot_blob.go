...
// SQL query builder for fct_data_column_availability_by_slot_blob
...
// BuildListFctDataColumnAvailabilityBySlotBlobQuery constructs a parameterized SQL query from a ListFctDataColumnAvailabilityBySlotBlobRequest
//
// Available projections:
//   - p_by_slot_blob_column (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctDataColumnAvailabilityBySlotBlobQuery(req *ListFctDataColumnAvailabilityBySlotBlobRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_data_column_availability_by_slot_blob", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctDataColumnAvailabilityBySlotBlobQuery constructs a parameterized SQL query from a GetFctDataColumnAvailabilityBySlotBlobRequest
func BuildGetFctDataColumnAvailabilityBySlotBlobQuery(req *GetFctDataColumnAvailabilityBySlotBlobRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_data_column_availability_by_slot_blob", columns, qb, orderByClause, 1, 0, options...)
}
