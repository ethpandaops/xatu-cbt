...
// SQL query builder for fct_engine_get_blobs_by_el_client
...
// BuildListFctEngineGetBlobsByElClientQuery constructs a parameterized SQL query from a ListFctEngineGetBlobsByElClientRequest
func BuildListFctEngineGetBlobsByElClientQuery(req *ListFctEngineGetBlobsByElClientRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "meta_execution_implementation", "meta_execution_version", "status", "node_class", "observation_count", "unique_node_count", "max_requested_count", "avg_returned_count", "avg_duration_ms", "median_duration_ms", "min_duration_ms", "max_duration_ms", "p95_duration_ms"}
		...
		orderByClause = " ORDER BY slot_start_date_time" + ", block_root" + ", meta_execution_implementation" + ", meta_execution_version" + ", status" + ", node_class"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "NULLIF(`block_root`, repeat('\x00', 66)) AS `block_root`", "meta_execution_implementation", "meta_execution_version", "status", "node_class", "observation_count", "unique_node_count", "max_requested_count", "avg_returned_count", "avg_duration_ms", "median_duration_ms", "min_duration_ms", "max_duration_ms", "p95_duration_ms"}

	return BuildParameterizedQuery("fct_engine_get_blobs_by_el_client", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctEngineGetBlobsByElClientQuery constructs a parameterized SQL query from a GetFctEngineGetBlobsByElClientRequest
func BuildGetFctEngineGetBlobsByElClientQuery(req *GetFctEngineGetBlobsByElClientRequest, options ...QueryOption) (SQLQuery, error) {
