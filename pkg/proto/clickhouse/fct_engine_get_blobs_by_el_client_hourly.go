...
// SQL query builder for fct_engine_get_blobs_by_el_client_hourly
...
// BuildListFctEngineGetBlobsByElClientHourlyQuery constructs a parameterized SQL query from a ListFctEngineGetBlobsByElClientHourlyRequest
func BuildListFctEngineGetBlobsByElClientHourlyQuery(req *ListFctEngineGetBlobsByElClientHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "meta_execution_implementation", "meta_execution_version", "node_class", "slot_count", "observation_count", "unique_node_count", "success_count", "partial_count", "empty_count", "unsupported_count", "error_count", "avg_returned_count", "avg_duration_ms", "p50_duration_ms", "p95_duration_ms", "min_duration_ms", "max_duration_ms"}
	...
	return BuildParameterizedQuery("fct_engine_get_blobs_by_el_client_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctEngineGetBlobsByElClientHourlyQuery constructs a parameterized SQL query from a GetFctEngineGetBlobsByElClientHourlyRequest
func BuildGetFctEngineGetBlobsByElClientHourlyQuery(req *GetFctEngineGetBlobsByElClientHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_engine_get_blobs_by_el_client_hourly", columns, qb, orderByClause, 1, 0, options...)
}
