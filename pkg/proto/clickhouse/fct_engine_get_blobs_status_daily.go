...
func BuildListFctEngineGetBlobsStatusDailyQuery(req *ListFctEngineGetBlobsStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "is_reference_node", "slot_count", "observation_count", "success_count", "partial_count", "empty_count", "unsupported_count", "error_count", "success_pct", "avg_duration_ms", "avg_p50_duration_ms", "avg_p95_duration_ms", "max_duration_ms"}
