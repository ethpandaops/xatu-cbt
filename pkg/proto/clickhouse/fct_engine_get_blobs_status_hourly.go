...
func BuildListFctEngineGetBlobsStatusHourlyQuery(req *ListFctEngineGetBlobsStatusHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "node_class", "slot_count", "observation_count", "success_count", "partial_count", "empty_count", "unsupported_count", "error_count", "success_pct", "avg_duration_ms", "avg_p50_duration_ms", "avg_p95_duration_ms", "max_duration_ms"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "node_class", "slot_count", "observation_count", "success_count", "partial_count", "empty_count", "unsupported_count", "error_count", "success_pct", "avg_duration_ms", "avg_p50_duration_ms", "avg_p95_duration_ms", "max_duration_ms"}
