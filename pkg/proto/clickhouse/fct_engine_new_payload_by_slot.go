...
func BuildListFctEngineNewPayloadBySlotQuery(req *ListFctEngineNewPayloadBySlotRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "block_hash", "block_number", "proposer_index", "gas_used", "gas_limit", "tx_count", "blob_count", "is_reference_node", "observation_count", "unique_node_count", "valid_count", "invalid_count", "syncing_count", "accepted_count", "invalid_block_hash_count", "error_count", "valid_pct", "avg_duration_ms", "median_duration_ms", "min_duration_ms", "max_duration_ms", "p95_duration_ms", "p99_duration_ms", "unique_cl_implementation_count", "unique_el_implementation_count"}
		...
		orderByClause = " ORDER BY slot_start_date_time" + ", block_hash" + ", is_reference_node"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "NULLIF(`block_root`, repeat('\x00', 66)) AS `block_root`", "NULLIF(`block_hash`, repeat('\x00', 66)) AS `block_hash`", "block_number", "proposer_index", "gas_used", "gas_limit", "tx_count", "blob_count", "is_reference_node", "observation_count", "unique_node_count", "valid_count", "invalid_count", "syncing_count", "accepted_count", "invalid_block_hash_count", "error_count", "valid_pct", "avg_duration_ms", "median_duration_ms", "min_duration_ms", "max_duration_ms", "p95_duration_ms", "p99_duration_ms", "unique_cl_implementation_count", "unique_el_implementation_count"}
