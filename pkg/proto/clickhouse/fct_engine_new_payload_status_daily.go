...
// SQL query builder for fct_engine_new_payload_status_daily
...
// BuildListFctEngineNewPayloadStatusDailyQuery constructs a parameterized SQL query from a ListFctEngineNewPayloadStatusDailyRequest
func BuildListFctEngineNewPayloadStatusDailyQuery(req *ListFctEngineNewPayloadStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetFctEngineNewPayloadStatusDailyQuery constructs a parameterized SQL query from a GetFctEngineNewPayloadStatusDailyRequest
func BuildGetFctEngineNewPayloadStatusDailyQuery(req *GetFctEngineNewPayloadStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
