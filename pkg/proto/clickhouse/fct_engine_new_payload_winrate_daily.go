...
// SQL query builder for fct_engine_new_payload_winrate_daily
...
// BuildListFctEngineNewPayloadWinrateDailyQuery constructs a parameterized SQL query from a ListFctEngineNewPayloadWinrateDailyRequest
func BuildListFctEngineNewPayloadWinrateDailyQuery(req *ListFctEngineNewPayloadWinrateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "node_class", "meta_execution_implementation", "win_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", node_class" + ", meta_execution_implementation"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "node_class", "meta_execution_implementation", "win_count"}

	return BuildParameterizedQuery("fct_engine_new_payload_winrate_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctEngineNewPayloadWinrateDailyQuery constructs a parameterized SQL query from a GetFctEngineNewPayloadWinrateDailyRequest
func BuildGetFctEngineNewPayloadWinrateDailyQuery(req *GetFctEngineNewPayloadWinrateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_engine_new_payload_winrate_daily", columns, qb, orderByClause, 1, 0, options...)
}
