...
func BuildListFctEngineNewPayloadWinrateDailyQuery(req *ListFctEngineNewPayloadWinrateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "meta_execution_implementation", "win_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", meta_execution_implementation"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "meta_execution_implementation", "win_count"}
