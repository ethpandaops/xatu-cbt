...
func BuildListFctEngineNewPayloadWinrateHourlyQuery(req *ListFctEngineNewPayloadWinrateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "node_class", "meta_execution_implementation", "win_count"}
		...
		orderByClause = " ORDER BY hour_start_date_time" + ", node_class" + ", meta_execution_implementation"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "node_class", "meta_execution_implementation", "win_count"}
