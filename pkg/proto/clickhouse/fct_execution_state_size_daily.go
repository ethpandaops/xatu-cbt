...
// SQL query builder for fct_execution_state_size_daily
...
// BuildListFctExecutionStateSizeDailyQuery constructs a parameterized SQL query from a ListFctExecutionStateSizeDailyRequest
