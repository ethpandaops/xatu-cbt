...
// SQL query builder for fct_head_first_seen_by_node
...
// BuildListFctHeadFirstSeenByNodeQuery constructs a parameterized SQL query from a ListFctHeadFirstSeenByNodeRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctHeadFirstSeenByNodeQuery(req *ListFctHeadFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_head_first_seen_by_node", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctHeadFirstSeenByNodeQuery constructs a parameterized SQL query from a GetFctHeadFirstSeenByNodeRequest
func BuildGetFctHeadFirstSeenByNodeQuery(req *GetFctHeadFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_head_first_seen_by_node", columns, qb, orderByClause, 1, 0, options...)
}
