...
// SQL query builder for fct_head_vote_correctness_rate_hourly
...
// BuildListFctHeadVoteCorrectnessRateHourlyQuery constructs a parameterized SQL query from a ListFctHeadVoteCorrectnessRateHourlyRequest
func BuildListFctHeadVoteCorrectnessRateHourlyQuery(req *ListFctHeadVoteCorrectnessRateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "slot_count", "avg_head_vote_rate", "min_head_vote_rate", "max_head_vote_rate", "p05_head_vote_rate", "p50_head_vote_rate", "p95_head_vote_rate", "stddev_head_vote_rate", "upper_band_head_vote_rate", "lower_band_head_vote_rate", "moving_avg_head_vote_rate"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "slot_count", "avg_head_vote_rate", "min_head_vote_rate", "max_head_vote_rate", "p05_head_vote_rate", "p50_head_vote_rate", "p95_head_vote_rate", "stddev_head_vote_rate", "upper_band_head_vote_rate", "lower_band_head_vote_rate", "moving_avg_head_vote_rate"}

	return BuildParameterizedQuery("fct_head_vote_correctness_rate_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctHeadVoteCorrectnessRateHourlyQuery constructs a parameterized SQL query from a GetFctHeadVoteCorrectnessRateHourlyRequest
func BuildGetFctHeadVoteCorrectnessRateHourlyQuery(req *GetFctHeadVoteCorrectnessRateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_head_vote_correctness_rate_hourly", columns, qb, orderByClause, 1, 0, options...)
}
