...
// SQL query builder for fct_mev_bid_by_builder
...
// BuildListFctMevBidByBuilderQuery constructs a parameterized SQL query from a ListFctMevBidByBuilderRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctMevBidByBuilderQuery(req *ListFctMevBidByBuilderRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_mev_bid_by_builder", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctMevBidByBuilderQuery constructs a parameterized SQL query from a GetFctMevBidByBuilderRequest
func BuildGetFctMevBidByBuilderQuery(req *GetFctMevBidByBuilderRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_mev_bid_by_builder", columns, qb, orderByClause, 1, 0, options...)
}
