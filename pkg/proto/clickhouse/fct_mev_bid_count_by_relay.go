...
// SQL query builder for fct_mev_bid_count_by_relay
...
// BuildListFctMevBidCountByRelayQuery constructs a parameterized SQL query from a ListFctMevBidCountByRelayRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctMevBidCountByRelayQuery(req *ListFctMevBidCountByRelayRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "relay_name", "bid_total"}
...
func BuildGetFctMevBidCountByRelayQuery(req *GetFctMevBidCountByRelayRequest, options ...QueryOption) (SQLQuery, error) {
