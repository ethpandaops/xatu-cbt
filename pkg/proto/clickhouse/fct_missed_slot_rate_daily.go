...
// SQL query builder for fct_missed_slot_rate_daily
...
// BuildListFctMissedSlotRateDailyQuery constructs a parameterized SQL query from a ListFctMissedSlotRateDailyRequest
func BuildListFctMissedSlotRateDailyQuery(req *ListFctMissedSlotRateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "slot_count", "missed_count", "missed_rate", "moving_avg_missed_rate"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "slot_count", "missed_count", "missed_rate", "moving_avg_missed_rate"}

	return BuildParameterizedQuery("fct_missed_slot_rate_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctMissedSlotRateDailyQuery constructs a parameterized SQL query from a GetFctMissedSlotRateDailyRequest
func BuildGetFctMissedSlotRateDailyQuery(req *GetFctMissedSlotRateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_missed_slot_rate_daily", columns, qb, orderByClause, 1, 0, options...)
}
