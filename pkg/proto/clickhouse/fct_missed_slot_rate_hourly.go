...
// SQL query builder for fct_missed_slot_rate_hourly
...
// BuildListFctMissedSlotRateHourlyQuery constructs a parameterized SQL query from a ListFctMissedSlotRateHourlyRequest
func BuildListFctMissedSlotRateHourlyQuery(req *ListFctMissedSlotRateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: missed_rate

	// Add filter for column: moving_avg_missed_rate
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "slot_count", "missed_count", "missed_rate", "moving_avg_missed_rate"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "slot_count", "missed_count", "missed_rate", "moving_avg_missed_rate"}

	return BuildParameterizedQuery("fct_missed_slot_rate_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctMissedSlotRateHourlyQuery constructs a parameterized SQL query from a GetFctMissedSlotRateHourlyRequest
func BuildGetFctMissedSlotRateHourlyQuery(req *GetFctMissedSlotRateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_missed_slot_rate_hourly", columns, qb, orderByClause, 1, 0, options...)
}
