...
// SQL query builder for mainnet.fct_node_active_last_24h
...
func BuildListFctNodeActiveLast24HQuery(req *ListFctNodeActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "fct_node_active_last_24h", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetFctNodeActiveLast24HQuery(req *GetFctNodeActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "fct_node_active_last_24h", qb, orderByClause, 1, 0, options...), nil
}
