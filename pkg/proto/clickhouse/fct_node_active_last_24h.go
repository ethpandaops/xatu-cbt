...
// SQL query builder for fct_node_active_last_24h
...
func BuildListFctNodeActiveLast24HQuery(req *ListFctNodeActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "last_seen_date_time", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_consensus_version", "meta_consensus_implementation"}
...
func BuildGetFctNodeActiveLast24HQuery(req *GetFctNodeActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
