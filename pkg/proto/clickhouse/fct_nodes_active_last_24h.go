...
// SQL query builder for mainnet.fct_nodes_active_last_24h
...
// BuildListFctNodesActiveLast24HQuery constructs a parameterized SQL query from a ListFctNodesActiveLast24HRequest
func BuildListFctNodesActiveLast24HQuery(req *ListFctNodesActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "fct_nodes_active_last_24h", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetFctNodesActiveLast24HQuery constructs a parameterized SQL query from a GetFctNodesActiveLast24HRequest
func BuildGetFctNodesActiveLast24HQuery(req *GetFctNodesActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "fct_nodes_active_last_24h", qb, orderByClause, 1, 0, options...), nil
}
