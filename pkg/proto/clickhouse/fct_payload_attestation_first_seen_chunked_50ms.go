...
// SQL query builder for fct_payload_attestation_first_seen_chunked_50ms
...
// BuildListFctPayloadAttestationFirstSeenChunked50MsQuery constructs a parameterized SQL query from a ListFctPayloadAttestationFirstSeenChunked50MsRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctPayloadAttestationFirstSeenChunked50MsQuery(req *ListFctPayloadAttestationFirstSeenChunked50MsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "block_root", "chunk_slot_start_diff", "attestation_count"}

	return BuildParameterizedQuery("fct_payload_attestation_first_seen_chunked_50ms", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPayloadAttestationFirstSeenChunked50MsQuery constructs a parameterized SQL query from a GetFctPayloadAttestationFirstSeenChunked50MsRequest
func BuildGetFctPayloadAttestationFirstSeenChunked50MsQuery(req *GetFctPayloadAttestationFirstSeenChunked50MsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_payload_attestation_first_seen_chunked_50ms", columns, qb, orderByClause, 1, 0, options...)
}
