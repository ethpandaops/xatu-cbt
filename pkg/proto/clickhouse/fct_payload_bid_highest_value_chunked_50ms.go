...
// SQL query builder for fct_payload_bid_highest_value_chunked_50ms
...
// BuildListFctPayloadBidHighestValueChunked50MsQuery constructs a parameterized SQL query from a ListFctPayloadBidHighestValueChunked50MsRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListFctPayloadBidHighestValueChunked50MsQuery(req *ListFctPayloadBidHighestValueChunked50MsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "chunk_slot_start_diff", "earliest_bid_date_time", "block_hash", "builder_index", "value"}
		...
		orderByClause = " ORDER BY slot_start_date_time" + ", chunk_slot_start_diff"
	}
	...
	return BuildParameterizedQuery("fct_payload_bid_highest_value_chunked_50ms", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPayloadBidHighestValueChunked50MsQuery constructs a parameterized SQL query from a GetFctPayloadBidHighestValueChunked50MsRequest
func BuildGetFctPayloadBidHighestValueChunked50MsQuery(req *GetFctPayloadBidHighestValueChunked50MsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_payload_bid_highest_value_chunked_50ms", columns, qb, orderByClause, 1, 0, options...)
}
