...
// SQL query builder for fct_peer_count_by_custody_bucket_client_daily
...
// BuildListFctPeerCountByCustodyBucketClientDailyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketClientDailyRequest
func BuildListFctPeerCountByCustodyBucketClientDailyQuery(req *ListFctPeerCountByCustodyBucketClientDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "peer_agent_implementation", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", peer_agent_implementation" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "peer_agent_implementation", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_client_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketClientDailyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketClientDailyRequest
func BuildGetFctPeerCountByCustodyBucketClientDailyQuery(req *GetFctPeerCountByCustodyBucketClientDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_client_daily", columns, qb, orderByClause, 1, 0, options...)
}
