...
// SQL query builder for fct_peer_count_by_custody_bucket_client_hourly
...
// BuildListFctPeerCountByCustodyBucketClientHourlyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketClientHourlyRequest
func BuildListFctPeerCountByCustodyBucketClientHourlyQuery(req *ListFctPeerCountByCustodyBucketClientHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "peer_agent_implementation", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY hour_start_date_time" + ", peer_agent_implementation" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "peer_agent_implementation", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_client_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketClientHourlyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketClientHourlyRequest
func BuildGetFctPeerCountByCustodyBucketClientHourlyQuery(req *GetFctPeerCountByCustodyBucketClientHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_client_hourly", columns, qb, orderByClause, 1, 0, options...)
}
