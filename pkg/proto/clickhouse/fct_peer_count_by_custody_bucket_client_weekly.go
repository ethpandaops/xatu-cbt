...
// SQL query builder for fct_peer_count_by_custody_bucket_client_weekly
...
// BuildListFctPeerCountByCustodyBucketClientWeeklyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketClientWeeklyRequest
func BuildListFctPeerCountByCustodyBucketClientWeeklyQuery(req *ListFctPeerCountByCustodyBucketClientWeeklyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "week_start_date", "peer_agent_implementation", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY week_start_date" + ", peer_agent_implementation" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`week_start_date`) AS `week_start_date`", "peer_agent_implementation", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_client_weekly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketClientWeeklyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketClientWeeklyRequest
func BuildGetFctPeerCountByCustodyBucketClientWeeklyQuery(req *GetFctPeerCountByCustodyBucketClientWeeklyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_client_weekly", columns, qb, orderByClause, 1, 0, options...)
}
