...
// SQL query builder for fct_peer_count_by_custody_bucket_continent_daily
...
// BuildListFctPeerCountByCustodyBucketContinentDailyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketContinentDailyRequest
func BuildListFctPeerCountByCustodyBucketContinentDailyQuery(req *ListFctPeerCountByCustodyBucketContinentDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "peer_geo_continent_code", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", peer_geo_continent_code" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "peer_geo_continent_code", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_continent_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketContinentDailyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketContinentDailyRequest
func BuildGetFctPeerCountByCustodyBucketContinentDailyQuery(req *GetFctPeerCountByCustodyBucketContinentDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_continent_daily", columns, qb, orderByClause, 1, 0, options...)
}
