...
// SQL query builder for fct_peer_count_by_custody_bucket_continent_weekly
...
// BuildListFctPeerCountByCustodyBucketContinentWeeklyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketContinentWeeklyRequest
func BuildListFctPeerCountByCustodyBucketContinentWeeklyQuery(req *ListFctPeerCountByCustodyBucketContinentWeeklyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "week_start_date", "peer_geo_continent_code", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY week_start_date" + ", peer_geo_continent_code" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`week_start_date`) AS `week_start_date`", "peer_geo_continent_code", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_continent_weekly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketContinentWeeklyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketContinentWeeklyRequest
func BuildGetFctPeerCountByCustodyBucketContinentWeeklyQuery(req *GetFctPeerCountByCustodyBucketContinentWeeklyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_continent_weekly", columns, qb, orderByClause, 1, 0, options...)
}
