...
// SQL query builder for fct_peer_count_by_custody_bucket_country_daily
...
// BuildListFctPeerCountByCustodyBucketCountryDailyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketCountryDailyRequest
func BuildListFctPeerCountByCustodyBucketCountryDailyQuery(req *ListFctPeerCountByCustodyBucketCountryDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "peer_geo_country", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", peer_geo_country" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "peer_geo_country", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_country_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketCountryDailyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketCountryDailyRequest
func BuildGetFctPeerCountByCustodyBucketCountryDailyQuery(req *GetFctPeerCountByCustodyBucketCountryDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_country_daily", columns, qb, orderByClause, 1, 0, options...)
}
