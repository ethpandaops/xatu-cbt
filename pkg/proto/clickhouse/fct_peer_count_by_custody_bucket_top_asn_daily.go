...
// SQL query builder for fct_peer_count_by_custody_bucket_top_asn_daily
...
// BuildListFctPeerCountByCustodyBucketTopAsnDailyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketTopAsnDailyRequest
func BuildListFctPeerCountByCustodyBucketTopAsnDailyQuery(req *ListFctPeerCountByCustodyBucketTopAsnDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "asn_organization", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", asn_organization" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "asn_organization", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_top_asn_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketTopAsnDailyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketTopAsnDailyRequest
func BuildGetFctPeerCountByCustodyBucketTopAsnDailyQuery(req *GetFctPeerCountByCustodyBucketTopAsnDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_top_asn_daily", columns, qb, orderByClause, 1, 0, options...)
}
