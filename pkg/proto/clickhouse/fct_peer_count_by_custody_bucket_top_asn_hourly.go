...
// SQL query builder for fct_peer_count_by_custody_bucket_top_asn_hourly
...
// BuildListFctPeerCountByCustodyBucketTopAsnHourlyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketTopAsnHourlyRequest
func BuildListFctPeerCountByCustodyBucketTopAsnHourlyQuery(req *ListFctPeerCountByCustodyBucketTopAsnHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "asn_organization", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY hour_start_date_time" + ", asn_organization" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "asn_organization", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_top_asn_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketTopAsnHourlyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketTopAsnHourlyRequest
func BuildGetFctPeerCountByCustodyBucketTopAsnHourlyQuery(req *GetFctPeerCountByCustodyBucketTopAsnHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_top_asn_hourly", columns, qb, orderByClause, 1, 0, options...)
}
