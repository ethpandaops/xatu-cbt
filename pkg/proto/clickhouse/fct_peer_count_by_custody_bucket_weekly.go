...
// SQL query builder for fct_peer_count_by_custody_bucket_weekly
...
// BuildListFctPeerCountByCustodyBucketWeeklyQuery constructs a parameterized SQL query from a ListFctPeerCountByCustodyBucketWeeklyRequest
func BuildListFctPeerCountByCustodyBucketWeeklyQuery(req *ListFctPeerCountByCustodyBucketWeeklyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "week_start_date", "custody_bucket", "epoch_count", "peer_count"}
		...
		orderByClause = " ORDER BY week_start_date" + ", custody_bucket"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`week_start_date`) AS `week_start_date`", "custody_bucket", "epoch_count", "peer_count"}

	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_weekly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctPeerCountByCustodyBucketWeeklyQuery constructs a parameterized SQL query from a GetFctPeerCountByCustodyBucketWeeklyRequest
func BuildGetFctPeerCountByCustodyBucketWeeklyQuery(req *GetFctPeerCountByCustodyBucketWeeklyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_peer_count_by_custody_bucket_weekly", columns, qb, orderByClause, 1, 0, options...)
}
