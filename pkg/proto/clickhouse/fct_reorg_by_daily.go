...
// SQL query builder for fct_reorg_by_daily
...
// BuildListFctReorgByDailyQuery constructs a parameterized SQL query from a ListFctReorgByDailyRequest
func BuildListFctReorgByDailyQuery(req *ListFctReorgByDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "depth", "reorg_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", depth"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "toUInt32(`depth`) AS `depth`", "reorg_count"}

	return BuildParameterizedQuery("fct_reorg_by_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctReorgByDailyQuery constructs a parameterized SQL query from a GetFctReorgByDailyRequest
func BuildGetFctReorgByDailyQuery(req *GetFctReorgByDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_reorg_by_daily", columns, qb, orderByClause, 1, 0, options...)
}
