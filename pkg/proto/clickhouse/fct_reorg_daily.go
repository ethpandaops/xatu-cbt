...
// SQL query builder for fct_reorg_daily
...
// BuildListFctReorgDailyQuery constructs a parameterized SQL query from a ListFctReorgDailyRequest
func BuildListFctReorgDailyQuery(req *ListFctReorgDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_reorg_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctReorgDailyQuery constructs a parameterized SQL query from a GetFctReorgDailyRequest
func BuildGetFctReorgDailyQuery(req *GetFctReorgDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_reorg_daily", columns, qb, orderByClause, 1, 0, options...)
}
