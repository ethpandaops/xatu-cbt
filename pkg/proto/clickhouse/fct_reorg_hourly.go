...
// SQL query builder for fct_reorg_hourly
...
// BuildListFctReorgHourlyQuery constructs a parameterized SQL query from a ListFctReorgHourlyRequest
func BuildListFctReorgHourlyQuery(req *ListFctReorgHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_reorg_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctReorgHourlyQuery constructs a parameterized SQL query from a GetFctReorgHourlyRequest
func BuildGetFctReorgHourlyQuery(req *GetFctReorgHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_reorg_hourly", columns, qb, orderByClause, 1, 0, options...)
}
