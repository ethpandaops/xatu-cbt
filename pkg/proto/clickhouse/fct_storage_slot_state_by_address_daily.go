...
// SQL query builder for fct_storage_slot_state_by_address_daily
...
// BuildListFctStorageSlotStateByAddressDailyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateByAddressDailyRequest
func BuildListFctStorageSlotStateByAddressDailyQuery(req *ListFctStorageSlotStateByAddressDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_by_address_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateByAddressDailyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateByAddressDailyRequest
func BuildGetFctStorageSlotStateByAddressDailyQuery(req *GetFctStorageSlotStateByAddressDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_by_address_daily", columns, qb, orderByClause, 1, 0, options...)
}
