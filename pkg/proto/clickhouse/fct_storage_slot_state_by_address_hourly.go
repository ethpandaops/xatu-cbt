...
// SQL query builder for fct_storage_slot_state_by_address_hourly
...
// BuildListFctStorageSlotStateByAddressHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateByAddressHourlyRequest
func BuildListFctStorageSlotStateByAddressHourlyQuery(req *ListFctStorageSlotStateByAddressHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_by_address_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateByAddressHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateByAddressHourlyRequest
func BuildGetFctStorageSlotStateByAddressHourlyQuery(req *GetFctStorageSlotStateByAddressHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_by_address_hourly", columns, qb, orderByClause, 1, 0, options...)
}
