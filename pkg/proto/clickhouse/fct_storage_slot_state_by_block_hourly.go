...
// SQL query builder for fct_storage_slot_state_by_block_hourly
...
// BuildListFctStorageSlotStateByBlockHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateByBlockHourlyRequest
func BuildListFctStorageSlotStateByBlockHourlyQuery(req *ListFctStorageSlotStateByBlockHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_by_block_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateByBlockHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateByBlockHourlyRequest
func BuildGetFctStorageSlotStateByBlockHourlyQuery(req *GetFctStorageSlotStateByBlockHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_by_block_hourly", columns, qb, orderByClause, 1, 0, options...)
}
