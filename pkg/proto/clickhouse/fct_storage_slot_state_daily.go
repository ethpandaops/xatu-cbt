...
// SQL query builder for fct_storage_slot_state_daily
...
// BuildListFctStorageSlotStateDailyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateDailyRequest
func BuildListFctStorageSlotStateDailyQuery(req *ListFctStorageSlotStateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateDailyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateDailyRequest
func BuildGetFctStorageSlotStateDailyQuery(req *GetFctStorageSlotStateDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_daily", columns, qb, orderByClause, 1, 0, options...)
}
