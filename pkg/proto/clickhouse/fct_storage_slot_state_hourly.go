...
// SQL query builder for fct_storage_slot_state_hourly
...
// BuildListFctStorageSlotStateHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateHourlyRequest
func BuildListFctStorageSlotStateHourlyQuery(req *ListFctStorageSlotStateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateHourlyRequest
func BuildGetFctStorageSlotStateHourlyQuery(req *GetFctStorageSlotStateHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_hourly", columns, qb, orderByClause, 1, 0, options...)
}
