...
// SQL query builder for fct_storage_slot_state_with_expiry_by_6m_daily
...
// BuildListFctStorageSlotStateWithExpiryBy6MDailyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryBy6MDailyRequest
func BuildListFctStorageSlotStateWithExpiryBy6MDailyQuery(req *ListFctStorageSlotStateWithExpiryBy6MDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "active_slots", "effective_bytes"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_6m_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryBy6MDailyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryBy6MDailyRequest
func BuildGetFctStorageSlotStateWithExpiryBy6MDailyQuery(req *GetFctStorageSlotStateWithExpiryBy6MDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_6m_daily", columns, qb, orderByClause, 1, 0, options...)
}
