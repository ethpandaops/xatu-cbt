...
// SQL query builder for fct_storage_slot_state_with_expiry_by_6m_hourly
...
// BuildListFctStorageSlotStateWithExpiryBy6MHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryBy6MHourlyRequest
func BuildListFctStorageSlotStateWithExpiryBy6MHourlyQuery(req *ListFctStorageSlotStateWithExpiryBy6MHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "active_slots", "effective_bytes"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_6m_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryBy6MHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryBy6MHourlyRequest
func BuildGetFctStorageSlotStateWithExpiryBy6MHourlyQuery(req *GetFctStorageSlotStateWithExpiryBy6MHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_6m_hourly", columns, qb, orderByClause, 1, 0, options...)
}
