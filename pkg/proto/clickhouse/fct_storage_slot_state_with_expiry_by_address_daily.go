...
// SQL query builder for fct_storage_slot_state_with_expiry_by_address_daily
...
// BuildListFctStorageSlotStateWithExpiryByAddressDailyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryByAddressDailyRequest
func BuildListFctStorageSlotStateWithExpiryByAddressDailyQuery(req *ListFctStorageSlotStateWithExpiryByAddressDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_address_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryByAddressDailyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryByAddressDailyRequest
func BuildGetFctStorageSlotStateWithExpiryByAddressDailyQuery(req *GetFctStorageSlotStateWithExpiryByAddressDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_address_daily", columns, qb, orderByClause, 1, 0, options...)
}
