...
// SQL query builder for fct_storage_slot_state_with_expiry_by_address_hourly
...
// BuildListFctStorageSlotStateWithExpiryByAddressHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryByAddressHourlyRequest
func BuildListFctStorageSlotStateWithExpiryByAddressHourlyQuery(req *ListFctStorageSlotStateWithExpiryByAddressHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_address_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryByAddressHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryByAddressHourlyRequest
func BuildGetFctStorageSlotStateWithExpiryByAddressHourlyQuery(req *GetFctStorageSlotStateWithExpiryByAddressHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_address_hourly", columns, qb, orderByClause, 1, 0, options...)
}
