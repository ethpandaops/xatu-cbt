...
// SQL query builder for fct_storage_slot_state_with_expiry_by_block_daily
...
// BuildListFctStorageSlotStateWithExpiryByBlockDailyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryByBlockDailyRequest
func BuildListFctStorageSlotStateWithExpiryByBlockDailyQuery(req *ListFctStorageSlotStateWithExpiryByBlockDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "expiry_policy", "active_slots", "effective_bytes"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "expiry_policy", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_block_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryByBlockDailyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryByBlockDailyRequest
func BuildGetFctStorageSlotStateWithExpiryByBlockDailyQuery(req *GetFctStorageSlotStateWithExpiryByBlockDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_block_daily", columns, qb, orderByClause, 1, 0, options...)
}
