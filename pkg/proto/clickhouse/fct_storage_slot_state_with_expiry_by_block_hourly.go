...
// SQL query builder for fct_storage_slot_state_with_expiry_by_block_hourly
...
// BuildListFctStorageSlotStateWithExpiryByBlockHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryByBlockHourlyRequest
func BuildListFctStorageSlotStateWithExpiryByBlockHourlyQuery(req *ListFctStorageSlotStateWithExpiryByBlockHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "expiry_policy", "active_slots", "effective_bytes"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "expiry_policy", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_block_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryByBlockHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryByBlockHourlyRequest
func BuildGetFctStorageSlotStateWithExpiryByBlockHourlyQuery(req *GetFctStorageSlotStateWithExpiryByBlockHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_by_block_hourly", columns, qb, orderByClause, 1, 0, options...)
}
