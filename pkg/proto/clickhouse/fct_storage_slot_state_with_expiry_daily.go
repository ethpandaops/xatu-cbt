...
// SQL query builder for fct_storage_slot_state_with_expiry_daily
...
// BuildListFctStorageSlotStateWithExpiryDailyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryDailyRequest
func BuildListFctStorageSlotStateWithExpiryDailyQuery(req *ListFctStorageSlotStateWithExpiryDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryDailyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryDailyRequest
func BuildGetFctStorageSlotStateWithExpiryDailyQuery(req *GetFctStorageSlotStateWithExpiryDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_daily", columns, qb, orderByClause, 1, 0, options...)
}
