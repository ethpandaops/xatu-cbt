...
// SQL query builder for fct_storage_slot_state_with_expiry_hourly
...
// BuildListFctStorageSlotStateWithExpiryHourlyQuery constructs a parameterized SQL query from a ListFctStorageSlotStateWithExpiryHourlyRequest
func BuildListFctStorageSlotStateWithExpiryHourlyQuery(req *ListFctStorageSlotStateWithExpiryHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_hourly", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotStateWithExpiryHourlyQuery constructs a parameterized SQL query from a GetFctStorageSlotStateWithExpiryHourlyRequest
func BuildGetFctStorageSlotStateWithExpiryHourlyQuery(req *GetFctStorageSlotStateWithExpiryHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_state_with_expiry_hourly", columns, qb, orderByClause, 1, 0, options...)
}
