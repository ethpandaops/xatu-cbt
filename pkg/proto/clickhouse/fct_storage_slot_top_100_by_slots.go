...
func BuildListFctStorageSlotTop100BySlotsQuery(req *ListFctStorageSlotTop100BySlotsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "expiry_policy", "rank", "contract_address", "active_slots", "effective_bytes", "owner_key", "account_owner", "contract_name", "factory_contract", "labels"}
