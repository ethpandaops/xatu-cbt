...
// SQL query builder for fct_storage_slot_top_100_by_slots
...
// BuildListFctStorageSlotTop100BySlotsQuery constructs a parameterized SQL query from a ListFctStorageSlotTop100BySlotsRequest
func BuildListFctStorageSlotTop100BySlotsQuery(req *ListFctStorageSlotTop100BySlotsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_top_100_by_slots", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctStorageSlotTop100BySlotsQuery constructs a parameterized SQL query from a GetFctStorageSlotTop100BySlotsRequest
func BuildGetFctStorageSlotTop100BySlotsQuery(req *GetFctStorageSlotTop100BySlotsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_storage_slot_top_100_by_slots", columns, qb, orderByClause, 1, 0, options...)
}
