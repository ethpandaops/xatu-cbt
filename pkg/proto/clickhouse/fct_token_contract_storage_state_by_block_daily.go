...
// SQL query builder for fct_token_contract_storage_state_by_block_daily
...
// BuildListFctTokenContractStorageStateByBlockDailyQuery constructs a parameterized SQL query from a ListFctTokenContractStorageStateByBlockDailyRequest
func BuildListFctTokenContractStorageStateByBlockDailyQuery(req *ListFctTokenContractStorageStateByBlockDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "token_standard", "active_slots"}
		...
		orderByClause = " ORDER BY day_start_date" + ", token_standard"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "token_standard", "active_slots"}

	return BuildParameterizedQuery("fct_token_contract_storage_state_by_block_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctTokenContractStorageStateByBlockDailyQuery constructs a parameterized SQL query from a GetFctTokenContractStorageStateByBlockDailyRequest
func BuildGetFctTokenContractStorageStateByBlockDailyQuery(req *GetFctTokenContractStorageStateByBlockDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_token_contract_storage_state_by_block_daily", columns, qb, orderByClause, 1, 0, options...)
}
