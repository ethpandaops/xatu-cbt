...
// SQL query builder for fct_transaction_inclusion_daily
...
// BuildListFctTransactionInclusionDailyQuery constructs a parameterized SQL query from a ListFctTransactionInclusionDailyRequest
func BuildListFctTransactionInclusionDailyQuery(req *ListFctTransactionInclusionDailyRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetFctTransactionInclusionDailyQuery constructs a parameterized SQL query from a GetFctTransactionInclusionDailyRequest
func BuildGetFctTransactionInclusionDailyQuery(req *GetFctTransactionInclusionDailyRequest, options ...QueryOption) (SQLQuery, error) {
