...
func BuildListFctTransactionInclusionHourlyQuery(req *ListFctTransactionInclusionHourlyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "hour_start_date_time", "included_count", "relay_delivered_count", "unknown_build_count", "type0_count", "type1_count", "type2_count", "type3_count", "type4_count", "type_other_count", "blob_count", "contract_creation_count", "cancel_shape_count", "unique_senders"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`hour_start_date_time`) AS `hour_start_date_time`", "included_count", "relay_delivered_count", "unknown_build_count", "type0_count", "type1_count", "type2_count", "type3_count", "type4_count", "type_other_count", "blob_count", "contract_creation_count", "cancel_shape_count", "unique_senders"}
