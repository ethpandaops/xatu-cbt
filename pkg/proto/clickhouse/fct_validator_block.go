...
// SQL query builder for fct_validator_block
...
// BuildListFctValidatorBlockQuery constructs a parameterized SQL query from a ListFctValidatorBlockRequest
//
...
func BuildListFctValidatorBlockQuery(req *ListFctValidatorBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_validator_block", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctValidatorBlockQuery constructs a parameterized SQL query from a GetFctValidatorBlockRequest
func BuildGetFctValidatorBlockQuery(req *GetFctValidatorBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_validator_block", columns, qb, orderByClause, 1, 0, options...)
}
