...
// SQL query builder for fct_validator_count_by_entity_by_status_daily
...
// BuildListFctValidatorCountByEntityByStatusDailyQuery constructs a parameterized SQL query from a ListFctValidatorCountByEntityByStatusDailyRequest
func BuildListFctValidatorCountByEntityByStatusDailyQuery(req *ListFctValidatorCountByEntityByStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "day_start_date", "entity", "status", "validator_count"}
		...
		orderByClause = " ORDER BY day_start_date" + ", entity" + ", status"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toString(`day_start_date`) AS `day_start_date`", "entity", "status", "validator_count"}

	return BuildParameterizedQuery("fct_validator_count_by_entity_by_status_daily", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetFctValidatorCountByEntityByStatusDailyQuery constructs a parameterized SQL query from a GetFctValidatorCountByEntityByStatusDailyRequest
func BuildGetFctValidatorCountByEntityByStatusDailyQuery(req *GetFctValidatorCountByEntityByStatusDailyRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("fct_validator_count_by_entity_by_status_daily", columns, qb, orderByClause, 1, 0, options...)
}
