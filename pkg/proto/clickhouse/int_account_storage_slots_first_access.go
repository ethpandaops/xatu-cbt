...
// SQL query builder for mainnet.int_account_storage_slots_first_access
...
// BuildListIntAccountStorageSlotsFirstAccessQuery constructs a parameterized SQL query from a ListIntAccountStorageSlotsFirstAccessRequest
func BuildListIntAccountStorageSlotsFirstAccessQuery(req *ListIntAccountStorageSlotsFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_account_storage_slots_first_access", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntAccountStorageSlotsFirstAccessQuery constructs a parameterized SQL query from a GetIntAccountStorageSlotsFirstAccessRequest
func BuildGetIntAccountStorageSlotsFirstAccessQuery(req *GetIntAccountStorageSlotsFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	if req.Address == "" {
		return SQLQuery{}, fmt.Errorf("primary key field address is required")
	}
	...
	return BuildParameterizedQuery("mainnet", "int_account_storage_slots_first_access", qb, orderByClause, 1, 0, options...), nil
}
