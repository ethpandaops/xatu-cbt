...
// SQL query builder for mainnet.int_account_storage_slots_last_access
...
// BuildListIntAccountStorageSlotsLastAccessQuery constructs a parameterized SQL query from a ListIntAccountStorageSlotsLastAccessRequest
func BuildListIntAccountStorageSlotsLastAccessQuery(req *ListIntAccountStorageSlotsLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"address", "slot_key", "block_number", "value"}
	...
	return BuildParameterizedQuery("mainnet", "int_account_storage_slots_last_access", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntAccountStorageSlotsLastAccessQuery constructs a parameterized SQL query from a GetIntAccountStorageSlotsLastAccessRequest
func BuildGetIntAccountStorageSlotsLastAccessQuery(req *GetIntAccountStorageSlotsLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	if req.Address == "" {
		return SQLQuery{}, fmt.Errorf("primary key field address is required")
	}
	...
	return BuildParameterizedQuery("mainnet", "int_account_storage_slots_last_access", qb, orderByClause, 1, 0, options...), nil
}
