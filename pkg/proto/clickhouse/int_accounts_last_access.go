...
// SQL query builder for mainnet.int_accounts_last_access
...
// BuildListIntAccountsLastAccessQuery constructs a parameterized SQL query from a ListIntAccountsLastAccessRequest
func BuildListIntAccountsLastAccessQuery(req *ListIntAccountsLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_accounts_last_access", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntAccountsLastAccessQuery constructs a parameterized SQL query from a GetIntAccountsLastAccessRequest
func BuildGetIntAccountsLastAccessQuery(req *GetIntAccountsLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	if req.Address == "" {
		return SQLQuery{}, fmt.Errorf("primary key field address is required")
	}
	...
	return BuildParameterizedQuery("mainnet", "int_accounts_last_access", qb, orderByClause, 1, 0, options...), nil
}
