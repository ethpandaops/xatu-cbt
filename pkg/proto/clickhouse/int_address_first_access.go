...
// SQL query builder for mainnet.int_address_first_access
...
func BuildListIntAddressFirstAccessQuery(req *ListIntAddressFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_first_access", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntAddressFirstAccessQuery(req *GetIntAddressFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_first_access", qb, orderByClause, 1, 0, options...), nil
}
