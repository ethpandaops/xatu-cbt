...
// SQL query builder for mainnet.int_address_last_access
...
func BuildListIntAddressLastAccessQuery(req *ListIntAddressLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_last_access", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntAddressLastAccessQuery(req *GetIntAddressLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_last_access", qb, orderByClause, 1, 0, options...), nil
}
