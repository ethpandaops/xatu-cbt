...
// SQL query builder for int_address_reads
...
// BuildListIntAddressReadsQuery constructs a parameterized SQL query from a ListIntAddressReadsRequest
func BuildListIntAddressReadsQuery(req *ListIntAddressReadsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_address_reads", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntAddressReadsQuery constructs a parameterized SQL query from a GetIntAddressReadsRequest
func BuildGetIntAddressReadsQuery(req *GetIntAddressReadsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_address_reads", columns, qb, orderByClause, 1, 0, options...)
}
