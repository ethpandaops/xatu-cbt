...
// SQL query builder for mainnet.int_address_storage_first_access
...
func BuildListIntAddressStorageFirstAccessQuery(req *ListIntAddressStorageFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_storage_first_access", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntAddressStorageFirstAccessQuery(req *GetIntAddressStorageFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_storage_first_access", qb, orderByClause, 1, 0, options...), nil
}
