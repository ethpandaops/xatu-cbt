...
// SQL query builder for mainnet.int_address_storage_last_access
...
func BuildListIntAddressStorageLastAccessQuery(req *ListIntAddressStorageLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_storage_last_access", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntAddressStorageLastAccessQuery(req *GetIntAddressStorageLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_storage_last_access", qb, orderByClause, 1, 0, options...), nil
}
