...
// SQL query builder for mainnet.int_address_storage_slot_last_access
...
// BuildListIntAddressStorageSlotLastAccessQuery constructs a parameterized SQL query from a ListIntAddressStorageSlotLastAccessRequest
func BuildListIntAddressStorageSlotLastAccessQuery(req *ListIntAddressStorageSlotLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_address_storage_slot_last_access", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntAddressStorageSlotLastAccessQuery(req *GetIntAddressStorageSlotLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	if req.Address == "" {
		return SQLQuery{}, fmt.Errorf("primary key field address is required")
	}
	...
	return BuildParameterizedQuery("mainnet", "int_address_storage_slot_last_access", qb, orderByClause, 1, 0, options...), nil
}
