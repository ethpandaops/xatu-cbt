...
// SQL query builder for mainnet.int_addresses_first_access
...
// BuildListIntAddressesFirstAccessQuery constructs a parameterized SQL query from a ListIntAddressesFirstAccessRequest
func BuildListIntAddressesFirstAccessQuery(req *ListIntAddressesFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_addresses_first_access", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntAddressesFirstAccessQuery constructs a parameterized SQL query from a GetIntAddressesFirstAccessRequest
func BuildGetIntAddressesFirstAccessQuery(req *GetIntAddressesFirstAccessRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	if req.Address == "" {
		return SQLQuery{}, fmt.Errorf("primary key field address is required")
	}
	...
	return BuildParameterizedQuery("mainnet", "int_addresses_first_access", qb, orderByClause, 1, 0, options...), nil
}
