...
// SQL query builder for mainnet.int_addresses_last_access
...
// BuildListIntAddressesLastAccessQuery constructs a parameterized SQL query from a ListIntAddressesLastAccessRequest
func BuildListIntAddressesLastAccessQuery(req *ListIntAddressesLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_addresses_last_access", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntAddressesLastAccessQuery constructs a parameterized SQL query from a GetIntAddressesLastAccessRequest
func BuildGetIntAddressesLastAccessQuery(req *GetIntAddressesLastAccessRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	if req.Address == "" {
		return SQLQuery{}, fmt.Errorf("primary key field address is required")
	}
	...
	return BuildParameterizedQuery("mainnet", "int_addresses_last_access", qb, orderByClause, 1, 0, options...), nil
}
