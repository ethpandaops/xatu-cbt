...
// SQL query builder for int_attestation_attested
...
// BuildListIntAttestationAttestedQuery constructs a parameterized SQL query from a ListIntAttestationAttestedRequest
func BuildListIntAttestationAttestedQuery(req *ListIntAttestationAttestedRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "source_epoch", "source_epoch_start_date_time", "source_root", "target_epoch", "target_epoch_start_date_time", "target_root", "block_root", "attesting_validator_index", "inclusion_distance", "propagation_distance"}
...
func BuildGetIntAttestationAttestedQuery(req *GetIntAttestationAttestedRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_attestation_attested", columns, qb, orderByClause, 1, 0, options...)
}
