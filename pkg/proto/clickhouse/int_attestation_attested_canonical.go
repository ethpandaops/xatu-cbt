...
// SQL query builder for int_attestation_attested_canonical
...
// BuildListIntAttestationAttestedCanonicalQuery constructs a parameterized SQL query from a ListIntAttestationAttestedCanonicalRequest
func BuildListIntAttestationAttestedCanonicalQuery(req *ListIntAttestationAttestedCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "source_epoch", "source_epoch_start_date_time", "source_root", "target_epoch", "target_epoch_start_date_time", "target_root", "block_root", "attesting_validator_index", "inclusion_distance"}
...
func BuildGetIntAttestationAttestedCanonicalQuery(req *GetIntAttestationAttestedCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
