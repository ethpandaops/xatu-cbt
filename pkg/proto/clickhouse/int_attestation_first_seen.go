...
// SQL query builder for mainnet.int_attestation_first_seen
...
func BuildListIntAttestationFirstSeenQuery(req *ListIntAttestationFirstSeenRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_attestation_first_seen", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntAttestationFirstSeenQuery(req *GetIntAttestationFirstSeenRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_attestation_first_seen", qb, orderByClause, 1, 0, options...), nil
}
