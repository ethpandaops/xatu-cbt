...
// SQL query builder for int_attestation_first_seen
...
// BuildListIntAttestationFirstSeenQuery constructs a parameterized SQL query from a ListIntAttestationFirstSeenRequest
func BuildListIntAttestationFirstSeenQuery(req *ListIntAttestationFirstSeenRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "source", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "seen_slot_start_diff", "block_root", "attesting_validator_index", "attesting_validator_committee_index", "source_epoch", "source_root", "target_epoch", "target_root", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_consensus_version", "meta_consensus_implementation"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "source", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "seen_slot_start_diff", "block_root", "attesting_validator_index", "attesting_validator_committee_index", "source_epoch", "source_root", "target_epoch", "target_root", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_consensus_version", "meta_consensus_implementation"}
...
func BuildGetIntAttestationFirstSeenQuery(req *GetIntAttestationFirstSeenRequest, options ...QueryOption) (SQLQuery, error) {
