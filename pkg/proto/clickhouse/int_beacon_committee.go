...
// SQL query builder for int_beacon_committee
...
// BuildListIntBeaconCommitteeQuery constructs a parameterized SQL query from a ListIntBeaconCommitteeRequest
func BuildListIntBeaconCommitteeQuery(req *ListIntBeaconCommitteeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "committee_index", "validators"}
	...
	return BuildParameterizedQuery("int_beacon_committee", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntBeaconCommitteeQuery constructs a parameterized SQL query from a GetIntBeaconCommitteeRequest
func BuildGetIntBeaconCommitteeQuery(req *GetIntBeaconCommitteeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_beacon_committee", columns, qb, orderByClause, 1, 0, options...)
}
