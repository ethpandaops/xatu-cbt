...
// SQL query builder for int_beacon_committee_head
...
// BuildListIntBeaconCommitteeHeadQuery constructs a parameterized SQL query from a ListIntBeaconCommitteeHeadRequest
func BuildListIntBeaconCommitteeHeadQuery(req *ListIntBeaconCommitteeHeadRequest, options ...QueryOption) (SQLQuery, error) {
...
func BuildGetIntBeaconCommitteeHeadQuery(req *GetIntBeaconCommitteeHeadRequest, options ...QueryOption) (SQLQuery, error) {
