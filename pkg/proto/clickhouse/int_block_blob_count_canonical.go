...
// SQL query builder for int_block_blob_count_canonical
...
// BuildListIntBlockBlobCountCanonicalQuery constructs a parameterized SQL query from a ListIntBlockBlobCountCanonicalRequest
func BuildListIntBlockBlobCountCanonicalQuery(req *ListIntBlockBlobCountCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
...
func BuildGetIntBlockBlobCountCanonicalQuery(req *GetIntBlockBlobCountCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
