...
// SQL query builder for int_block_blob_count_head
...
// BuildListIntBlockBlobCountHeadQuery constructs a parameterized SQL query from a ListIntBlockBlobCountHeadRequest
func BuildListIntBlockBlobCountHeadQuery(req *ListIntBlockBlobCountHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "blob_count"}
	...
	return BuildParameterizedQuery("int_block_blob_count_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlockBlobCountHeadQuery constructs a parameterized SQL query from a GetIntBlockBlobCountHeadRequest
func BuildGetIntBlockBlobCountHeadQuery(req *GetIntBlockBlobCountHeadRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("int_block_blob_count_head", qb, orderByClause, 1, 0, options...), nil
}
