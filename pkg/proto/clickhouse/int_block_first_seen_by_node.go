...
// SQL query builder for int_block_first_seen_by_node
...
func BuildListIntBlockFirstSeenByNodeQuery(req *ListIntBlockFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "source", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "seen_slot_start_diff", "block_root", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_consensus_version", "meta_consensus_implementation"}
	...
	return BuildParameterizedQuery("int_block_first_seen_by_node", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntBlockFirstSeenByNodeQuery(req *GetIntBlockFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_block_first_seen_by_node", qb, orderByClause, 1, 0, options...), nil
}
