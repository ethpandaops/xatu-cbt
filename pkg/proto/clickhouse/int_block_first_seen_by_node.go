...
// SQL query builder for mainnet.int_block_first_seen_by_node
...
func BuildListIntBlockFirstSeenByNodeQuery(req *ListIntBlockFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_first_seen_by_node", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlockFirstSeenByNodeQuery constructs a parameterized SQL query from a GetIntBlockFirstSeenByNodeRequest
func BuildGetIntBlockFirstSeenByNodeQuery(req *GetIntBlockFirstSeenByNodeRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_block_first_seen_by_node", qb, orderByClause, 1, 0, options...), nil
}
