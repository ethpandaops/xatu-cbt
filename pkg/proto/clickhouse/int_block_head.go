...
// SQL query builder for int_block_head
...
// BuildListIntBlockHeadQuery constructs a parameterized SQL query from a ListIntBlockHeadRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListIntBlockHeadQuery(req *ListIntBlockHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_block_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlockHeadQuery constructs a parameterized SQL query from a GetIntBlockHeadRequest
func BuildGetIntBlockHeadQuery(req *GetIntBlockHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_block_head", qb, orderByClause, 1, 0, options...), nil
}
