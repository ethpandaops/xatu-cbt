...
// SQL query builder for int_block_mev_head
...
// BuildListIntBlockMevHeadQuery constructs a parameterized SQL query from a ListIntBlockMevHeadRequest
//
// Available projections:
//   - p_by_slot (primary key: slot)
//
// Use WithProjection() option to select a specific projection.
func BuildListIntBlockMevHeadQuery(req *ListIntBlockMevHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_block_mev_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlockMevHeadQuery constructs a parameterized SQL query from a GetIntBlockMevHeadRequest
func BuildGetIntBlockMevHeadQuery(req *GetIntBlockMevHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_block_mev_head", qb, orderByClause, 1, 0, options...), nil
}
