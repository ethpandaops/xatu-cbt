...
// SQL query builder for mainnet.int_block_orphaned
...
func BuildListIntBlockOrphanedQuery(req *ListIntBlockOrphanedRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_orphaned", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntBlockOrphanedQuery(req *GetIntBlockOrphanedRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_orphaned", qb, orderByClause, 1, 0, options...), nil
}
