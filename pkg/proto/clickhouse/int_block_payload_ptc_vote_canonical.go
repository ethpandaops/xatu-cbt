...
// SQL query builder for int_block_payload_ptc_vote_canonical
...
// BuildListIntBlockPayloadPtcVoteCanonicalQuery constructs a parameterized SQL query from a ListIntBlockPayloadPtcVoteCanonicalRequest
func BuildListIntBlockPayloadPtcVoteCanonicalQuery(req *ListIntBlockPayloadPtcVoteCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "block_version", "included_in_slot", "included_in_block_root", "ptc_validators", "payload_present_votes", "blob_data_available_votes"}
	...
	return BuildParameterizedQuery("int_block_payload_ptc_vote_canonical", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntBlockPayloadPtcVoteCanonicalQuery constructs a parameterized SQL query from a GetIntBlockPayloadPtcVoteCanonicalRequest
func BuildGetIntBlockPayloadPtcVoteCanonicalQuery(req *GetIntBlockPayloadPtcVoteCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_block_payload_ptc_vote_canonical", columns, qb, orderByClause, 1, 0, options...)
}
