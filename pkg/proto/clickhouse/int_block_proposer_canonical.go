...
// SQL query builder for mainnet.int_block_proposer_canonical
...
func BuildListIntBlockProposerCanonicalQuery(req *ListIntBlockProposerCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposer_canonical", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntBlockProposerCanonicalQuery(req *GetIntBlockProposerCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposer_canonical", qb, orderByClause, 1, 0, options...), nil
}
