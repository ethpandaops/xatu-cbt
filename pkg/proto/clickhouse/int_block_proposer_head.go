...
// SQL query builder for mainnet.int_block_proposer_head
...
func BuildListIntBlockProposerHeadQuery(req *ListIntBlockProposerHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposer_head", qb, orderByClause, limit, offset, options...), nil
}
...
func BuildGetIntBlockProposerHeadQuery(req *GetIntBlockProposerHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposer_head", qb, orderByClause, 1, 0, options...), nil
}
