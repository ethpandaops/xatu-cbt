...
// SQL query builder for mainnet.int_block_proposers_canonical
...
// BuildListIntBlockProposersCanonicalQuery constructs a parameterized SQL query from a ListIntBlockProposersCanonicalRequest
func BuildListIntBlockProposersCanonicalQuery(req *ListIntBlockProposersCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposers_canonical", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlockProposersCanonicalQuery constructs a parameterized SQL query from a GetIntBlockProposersCanonicalRequest
func BuildGetIntBlockProposersCanonicalQuery(req *GetIntBlockProposersCanonicalRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposers_canonical", qb, orderByClause, 1, 0, options...), nil
}
