...
// SQL query builder for mainnet.int_block_proposers_head
...
// BuildListIntBlockProposersHeadQuery constructs a parameterized SQL query from a ListIntBlockProposersHeadRequest
func BuildListIntBlockProposersHeadQuery(req *ListIntBlockProposersHeadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposers_head", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlockProposersHeadQuery constructs a parameterized SQL query from a GetIntBlockProposersHeadRequest
func BuildGetIntBlockProposersHeadQuery(req *GetIntBlockProposersHeadRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_block_proposers_head", qb, orderByClause, 1, 0, options...), nil
}
