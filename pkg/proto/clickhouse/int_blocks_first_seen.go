...
// SQL query builder for mainnet.int_blocks_first_seen
...
// BuildListIntBlocksFirstSeenQuery constructs a parameterized SQL query from a ListIntBlocksFirstSeenRequest
func BuildListIntBlocksFirstSeenQuery(req *ListIntBlocksFirstSeenRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_blocks_first_seen", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlocksFirstSeenQuery constructs a parameterized SQL query from a GetIntBlocksFirstSeenRequest
func BuildGetIntBlocksFirstSeenQuery(req *GetIntBlocksFirstSeenRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_blocks_first_seen", qb, orderByClause, 1, 0, options...), nil
}
