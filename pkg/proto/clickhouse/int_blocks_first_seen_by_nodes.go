...
// SQL query builder for mainnet.int_blocks_first_seen_by_nodes
...
// BuildListIntBlocksFirstSeenByNodesQuery constructs a parameterized SQL query from a ListIntBlocksFirstSeenByNodesRequest
func BuildListIntBlocksFirstSeenByNodesQuery(req *ListIntBlocksFirstSeenByNodesRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "source", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "seen_slot_start_diff", "username", "node_id", "classification", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_consensus_version", "meta_consensus_implementation"}
	...
	return BuildParameterizedQuery("mainnet", "int_blocks_first_seen_by_nodes", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlocksFirstSeenByNodesQuery constructs a parameterized SQL query from a GetIntBlocksFirstSeenByNodesRequest
func BuildGetIntBlocksFirstSeenByNodesQuery(req *GetIntBlocksFirstSeenByNodesRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_blocks_first_seen_by_nodes", qb, orderByClause, 1, 0, options...), nil
}
