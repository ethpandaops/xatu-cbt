...
// SQL query builder for mainnet.int_blocks_orphaned
...
// BuildListIntBlocksOrphanedQuery constructs a parameterized SQL query from a ListIntBlocksOrphanedRequest
func BuildListIntBlocksOrphanedQuery(req *ListIntBlocksOrphanedRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_blocks_orphaned", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntBlocksOrphanedQuery constructs a parameterized SQL query from a GetIntBlocksOrphanedRequest
func BuildGetIntBlocksOrphanedQuery(req *GetIntBlocksOrphanedRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_blocks_orphaned", qb, orderByClause, 1, 0, options...), nil
}
