...
// SQL query builder for int_contract_storage_expiry_12m
...
// BuildListIntContractStorageExpiry12MQuery constructs a parameterized SQL query from a ListIntContractStorageExpiry12MRequest
func BuildListIntContractStorageExpiry12MQuery(req *ListIntContractStorageExpiry12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_12m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageExpiry12MQuery constructs a parameterized SQL query from a GetIntContractStorageExpiry12MRequest
func BuildGetIntContractStorageExpiry12MQuery(req *GetIntContractStorageExpiry12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_12m", columns, qb, orderByClause, 1, 0, options...)
}
