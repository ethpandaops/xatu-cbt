...
// SQL query builder for int_contract_storage_expiry_18m
...
// BuildListIntContractStorageExpiry18MQuery constructs a parameterized SQL query from a ListIntContractStorageExpiry18MRequest
func BuildListIntContractStorageExpiry18MQuery(req *ListIntContractStorageExpiry18MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_18m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageExpiry18MQuery constructs a parameterized SQL query from a GetIntContractStorageExpiry18MRequest
func BuildGetIntContractStorageExpiry18MQuery(req *GetIntContractStorageExpiry18MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_18m", columns, qb, orderByClause, 1, 0, options...)
}
