...
// SQL query builder for int_contract_storage_expiry_1m
...
// BuildListIntContractStorageExpiry1MQuery constructs a parameterized SQL query from a ListIntContractStorageExpiry1MRequest
func BuildListIntContractStorageExpiry1MQuery(req *ListIntContractStorageExpiry1MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_1m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageExpiry1MQuery constructs a parameterized SQL query from a GetIntContractStorageExpiry1MRequest
func BuildGetIntContractStorageExpiry1MQuery(req *GetIntContractStorageExpiry1MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_1m", columns, qb, orderByClause, 1, 0, options...)
}
