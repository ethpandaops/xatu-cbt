...
// SQL query builder for int_contract_storage_expiry_24m
...
// BuildListIntContractStorageExpiry24MQuery constructs a parameterized SQL query from a ListIntContractStorageExpiry24MRequest
func BuildListIntContractStorageExpiry24MQuery(req *ListIntContractStorageExpiry24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_24m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageExpiry24MQuery constructs a parameterized SQL query from a GetIntContractStorageExpiry24MRequest
func BuildGetIntContractStorageExpiry24MQuery(req *GetIntContractStorageExpiry24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_24m", columns, qb, orderByClause, 1, 0, options...)
}
