...
// SQL query builder for int_contract_storage_expiry_6m
...
// BuildListIntContractStorageExpiry6MQuery constructs a parameterized SQL query from a ListIntContractStorageExpiry6MRequest
func BuildListIntContractStorageExpiry6MQuery(req *ListIntContractStorageExpiry6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_6m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageExpiry6MQuery constructs a parameterized SQL query from a GetIntContractStorageExpiry6MRequest
func BuildGetIntContractStorageExpiry6MQuery(req *GetIntContractStorageExpiry6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_expiry_6m", columns, qb, orderByClause, 1, 0, options...)
}
