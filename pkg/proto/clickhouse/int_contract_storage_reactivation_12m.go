...
// SQL query builder for int_contract_storage_reactivation_12m
...
// BuildListIntContractStorageReactivation12MQuery constructs a parameterized SQL query from a ListIntContractStorageReactivation12MRequest
func BuildListIntContractStorageReactivation12MQuery(req *ListIntContractStorageReactivation12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_12m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageReactivation12MQuery constructs a parameterized SQL query from a GetIntContractStorageReactivation12MRequest
func BuildGetIntContractStorageReactivation12MQuery(req *GetIntContractStorageReactivation12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_12m", columns, qb, orderByClause, 1, 0, options...)
}
