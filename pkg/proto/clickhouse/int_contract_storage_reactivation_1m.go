...
// SQL query builder for int_contract_storage_reactivation_1m
...
// BuildListIntContractStorageReactivation1MQuery constructs a parameterized SQL query from a ListIntContractStorageReactivation1MRequest
func BuildListIntContractStorageReactivation1MQuery(req *ListIntContractStorageReactivation1MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_1m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageReactivation1MQuery constructs a parameterized SQL query from a GetIntContractStorageReactivation1MRequest
func BuildGetIntContractStorageReactivation1MQuery(req *GetIntContractStorageReactivation1MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_1m", columns, qb, orderByClause, 1, 0, options...)
}
