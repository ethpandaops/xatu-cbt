...
// SQL query builder for int_contract_storage_reactivation_24m
...
// BuildListIntContractStorageReactivation24MQuery constructs a parameterized SQL query from a ListIntContractStorageReactivation24MRequest
func BuildListIntContractStorageReactivation24MQuery(req *ListIntContractStorageReactivation24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_24m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageReactivation24MQuery constructs a parameterized SQL query from a GetIntContractStorageReactivation24MRequest
func BuildGetIntContractStorageReactivation24MQuery(req *GetIntContractStorageReactivation24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_24m", columns, qb, orderByClause, 1, 0, options...)
}
