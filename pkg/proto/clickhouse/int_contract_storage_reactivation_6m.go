...
// SQL query builder for int_contract_storage_reactivation_6m
...
// BuildListIntContractStorageReactivation6MQuery constructs a parameterized SQL query from a ListIntContractStorageReactivation6MRequest
func BuildListIntContractStorageReactivation6MQuery(req *ListIntContractStorageReactivation6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_6m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageReactivation6MQuery constructs a parameterized SQL query from a GetIntContractStorageReactivation6MRequest
func BuildGetIntContractStorageReactivation6MQuery(req *GetIntContractStorageReactivation6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_reactivation_6m", columns, qb, orderByClause, 1, 0, options...)
}
