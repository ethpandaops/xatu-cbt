...
// SQL query builder for int_contract_storage_state
...
// BuildListIntContractStorageStateQuery constructs a parameterized SQL query from a ListIntContractStorageStateRequest
func BuildListIntContractStorageStateQuery(req *ListIntContractStorageStateRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_state", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageStateQuery constructs a parameterized SQL query from a GetIntContractStorageStateRequest
func BuildGetIntContractStorageStateQuery(req *GetIntContractStorageStateRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_state", columns, qb, orderByClause, 1, 0, options...)
}
