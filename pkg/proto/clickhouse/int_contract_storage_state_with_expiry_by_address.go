...
// SQL query builder for int_contract_storage_state_with_expiry_by_address
...
// BuildListIntContractStorageStateWithExpiryByAddressQuery constructs a parameterized SQL query from a ListIntContractStorageStateWithExpiryByAddressRequest
func BuildListIntContractStorageStateWithExpiryByAddressQuery(req *ListIntContractStorageStateWithExpiryByAddressRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "address", "expiry_policy", "active_slots", "effective_bytes"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "address", "expiry_policy", "active_slots", "effective_bytes"}

	return BuildParameterizedQuery("int_contract_storage_state_with_expiry_by_address", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntContractStorageStateWithExpiryByAddressQuery constructs a parameterized SQL query from a GetIntContractStorageStateWithExpiryByAddressRequest
func BuildGetIntContractStorageStateWithExpiryByAddressQuery(req *GetIntContractStorageStateWithExpiryByAddressRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_contract_storage_state_with_expiry_by_address", columns, qb, orderByClause, 1, 0, options...)
}
