...
// SQL query builder for int_custody_probe_order_by_slot
...
// BuildListIntCustodyProbeOrderBySlotQuery constructs a parameterized SQL query from a ListIntCustodyProbeOrderBySlotRequest
func BuildListIntCustodyProbeOrderBySlotQuery(req *ListIntCustodyProbeOrderBySlotRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: probe_date_time
	...
	if req.ColumnIndices != nil {
		switch filter := req.ColumnIndices.Filter.(type) {
		case *ArrayUInt64Filter_Has:
			qb.AddArrayHasCondition("column_indices", filter.Has)
		case *ArrayUInt64Filter_HasAll:
			if len(filter.HasAll.Values) > 0 {
				qb.AddArrayHasAllCondition("column_indices", UInt64SliceToInterface(filter.HasAll.Values))
			}
		case *ArrayUInt64Filter_HasAny:
			if len(filter.HasAny.Values) > 0 {
				qb.AddArrayHasAnyCondition("column_indices", UInt64SliceToInterface(filter.HasAny.Values))
			}
		case *ArrayUInt64Filter_LengthEq:
			qb.AddArrayLengthCondition("column_indices", "=", filter.LengthEq)
		case *ArrayUInt64Filter_LengthGt:
			qb.AddArrayLengthCondition("column_indices", ">", filter.LengthGt)
		case *ArrayUInt64Filter_LengthGte:
			qb.AddArrayLengthCondition("column_indices", ">=", filter.LengthGte)
		case *ArrayUInt64Filter_LengthLt:
			qb.AddArrayLengthCondition("column_indices", "<", filter.LengthLt)
		case *ArrayUInt64Filter_LengthLte:
			qb.AddArrayLengthCondition("column_indices", "<=", filter.LengthLte)
		case *ArrayUInt64Filter_IsEmpty:
			qb.AddArrayIsEmptyCondition("column_indices")
		case *ArrayUInt64Filter_IsNotEmpty:
			qb.AddArrayIsNotEmptyCondition("column_indices")
		default:
			// Unsupported filter type
		}
	}

	// Add filter for column: blob_submitters
	if req.BlobSubmitters != nil {
		switch filter := req.BlobSubmitters.Filter.(type) {
		case *ArrayStringFilter_Has:
			qb.AddArrayHasCondition("blob_submitters", filter.Has)
		case *ArrayStringFilter_HasAll:
			if len(filter.HasAll.Values) > 0 {
				qb.AddArrayHasAllCondition("blob_submitters", StringSliceToInterface(filter.HasAll.Values))
			}
		case *ArrayStringFilter_HasAny:
			if len(filter.HasAny.Values) > 0 {
				qb.AddArrayHasAnyCondition("blob_submitters", StringSliceToInterface(filter.HasAny.Values))
			}
		case *ArrayStringFilter_LengthEq:
			qb.AddArrayLengthCondition("blob_submitters", "=", filter.LengthEq)
		case *ArrayStringFilter_LengthGt:
			qb.AddArrayLengthCondition("blob_submitters", ">", filter.LengthGt)
		case *ArrayStringFilter_LengthGte:
			qb.AddArrayLengthCondition("blob_submitters", ">=", filter.LengthGte)
		case *ArrayStringFilter_LengthLt:
			qb.AddArrayLengthCondition("blob_submitters", "<", filter.LengthLt)
		case *ArrayStringFilter_LengthLte:
			qb.AddArrayLengthCondition("blob_submitters", "<=", filter.LengthLte)
		case *ArrayStringFilter_IsEmpty:
			qb.AddArrayIsEmptyCondition("blob_submitters")
		case *ArrayStringFilter_IsNotEmpty:
			qb.AddArrayIsNotEmptyCondition("blob_submitters")
		default:
			// Unsupported filter type
		}
	}
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY slot_start_date_time" + ", slot" + ", peer_id_unique_key" + ", result" + ", error"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp(`probe_date_time`) AS `probe_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "peer_id_unique_key", "result", "error", "column_indices", "blob_submitters", "response_time_ms", "username", "node_id", "classification", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_peer_implementation", "meta_peer_version", "meta_peer_platform", "meta_peer_geo_city", "meta_peer_geo_country", "meta_peer_geo_country_code", "meta_peer_geo_continent_code", "meta_peer_geo_longitude", "meta_peer_geo_latitude", "meta_peer_geo_autonomous_system_number", "meta_peer_geo_autonomous_system_organization"}

	return BuildParameterizedQuery("int_custody_probe_order_by_slot", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntCustodyProbeOrderBySlotQuery constructs a parameterized SQL query from a GetIntCustodyProbeOrderBySlotRequest
func BuildGetIntCustodyProbeOrderBySlotQuery(req *GetIntCustodyProbeOrderBySlotRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_custody_probe_order_by_slot", columns, qb, orderByClause, 1, 0, options...)
}
