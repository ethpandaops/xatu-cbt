...
// SQL query builder for int_engine_new_payload_fastest
...
// BuildListIntEngineNewPayloadFastestQuery constructs a parameterized SQL query from a ListIntEngineNewPayloadFastestRequest
func BuildListIntEngineNewPayloadFastestQuery(req *ListIntEngineNewPayloadFastestRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_engine_new_payload_fastest", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntEngineNewPayloadFastestQuery constructs a parameterized SQL query from a GetIntEngineNewPayloadFastestRequest
func BuildGetIntEngineNewPayloadFastestQuery(req *GetIntEngineNewPayloadFastestRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_engine_new_payload_fastest", columns, qb, orderByClause, 1, 0, options...)
}
