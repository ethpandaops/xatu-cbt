...
// SQL query builder for mainnet.int_nodes_active_last_24h
...
// BuildListIntNodesActiveLast24HQuery constructs a parameterized SQL query from a ListIntNodesActiveLast24HRequest
func BuildListIntNodesActiveLast24HQuery(req *ListIntNodesActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mainnet", "int_nodes_active_last_24h", qb, orderByClause, limit, offset, options...), nil
}

// BuildGetIntNodesActiveLast24HQuery constructs a parameterized SQL query from a GetIntNodesActiveLast24HRequest
func BuildGetIntNodesActiveLast24HQuery(req *GetIntNodesActiveLast24HRequest, options ...QueryOption) (SQLQuery, error) {
	// Validate primary key is provided
	...
	return BuildParameterizedQuery("mainnet", "int_nodes_active_last_24h", qb, orderByClause, 1, 0, options...), nil
}
