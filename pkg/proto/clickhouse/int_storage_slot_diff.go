...
// SQL query builder for int_storage_slot_diff
...
// BuildListIntStorageSlotDiffQuery constructs a parameterized SQL query from a ListIntStorageSlotDiffRequest
func BuildListIntStorageSlotDiffQuery(req *ListIntStorageSlotDiffRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY block_number" + ", address" + ", slot_key"
	}
	...
	return BuildParameterizedQuery("int_storage_slot_diff", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotDiffQuery constructs a parameterized SQL query from a GetIntStorageSlotDiffRequest
func BuildGetIntStorageSlotDiffQuery(req *GetIntStorageSlotDiffRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_diff", columns, qb, orderByClause, 1, 0, options...)
}
