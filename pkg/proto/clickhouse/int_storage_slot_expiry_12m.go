...
// SQL query builder for int_storage_slot_expiry_12m
...
// BuildListIntStorageSlotExpiry12MQuery constructs a parameterized SQL query from a ListIntStorageSlotExpiry12MRequest
func BuildListIntStorageSlotExpiry12MQuery(req *ListIntStorageSlotExpiry12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_12m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotExpiry12MQuery constructs a parameterized SQL query from a GetIntStorageSlotExpiry12MRequest
func BuildGetIntStorageSlotExpiry12MQuery(req *GetIntStorageSlotExpiry12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_12m", columns, qb, orderByClause, 1, 0, options...)
}
