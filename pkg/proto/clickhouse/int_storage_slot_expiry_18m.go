...
// SQL query builder for int_storage_slot_expiry_18m
...
// BuildListIntStorageSlotExpiry18MQuery constructs a parameterized SQL query from a ListIntStorageSlotExpiry18MRequest
func BuildListIntStorageSlotExpiry18MQuery(req *ListIntStorageSlotExpiry18MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_18m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotExpiry18MQuery constructs a parameterized SQL query from a GetIntStorageSlotExpiry18MRequest
func BuildGetIntStorageSlotExpiry18MQuery(req *GetIntStorageSlotExpiry18MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_18m", columns, qb, orderByClause, 1, 0, options...)
}
