...
// SQL query builder for int_storage_slot_expiry_24m
...
// BuildListIntStorageSlotExpiry24MQuery constructs a parameterized SQL query from a ListIntStorageSlotExpiry24MRequest
func BuildListIntStorageSlotExpiry24MQuery(req *ListIntStorageSlotExpiry24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_24m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotExpiry24MQuery constructs a parameterized SQL query from a GetIntStorageSlotExpiry24MRequest
func BuildGetIntStorageSlotExpiry24MQuery(req *GetIntStorageSlotExpiry24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_24m", columns, qb, orderByClause, 1, 0, options...)
}
