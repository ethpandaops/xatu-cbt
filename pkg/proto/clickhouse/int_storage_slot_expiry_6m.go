...
// SQL query builder for int_storage_slot_expiry_6m
...
// BuildListIntStorageSlotExpiry6MQuery constructs a parameterized SQL query from a ListIntStorageSlotExpiry6MRequest
func BuildListIntStorageSlotExpiry6MQuery(req *ListIntStorageSlotExpiry6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_6m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotExpiry6MQuery constructs a parameterized SQL query from a GetIntStorageSlotExpiry6MRequest
func BuildGetIntStorageSlotExpiry6MQuery(req *GetIntStorageSlotExpiry6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_6m", columns, qb, orderByClause, 1, 0, options...)
}
