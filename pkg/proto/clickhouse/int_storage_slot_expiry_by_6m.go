...
// SQL query builder for int_storage_slot_expiry_by_6m
...
// BuildListIntStorageSlotExpiryBy6MQuery constructs a parameterized SQL query from a ListIntStorageSlotExpiryBy6MRequest
func BuildListIntStorageSlotExpiryBy6MQuery(req *ListIntStorageSlotExpiryBy6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_by_6m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotExpiryBy6MQuery constructs a parameterized SQL query from a GetIntStorageSlotExpiryBy6MRequest
func BuildGetIntStorageSlotExpiryBy6MQuery(req *GetIntStorageSlotExpiryBy6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_expiry_by_6m", columns, qb, orderByClause, 1, 0, options...)
}
