...
// SQL query builder for int_storage_slot_next_touch
...
// BuildListIntStorageSlotNextTouchQuery constructs a parameterized SQL query from a ListIntStorageSlotNextTouchRequest
//
// Available projections:
//   - proj_by_next_touch_block (primary key: next_touch_block)
//
// Use WithProjection() option to select a specific projection.
func BuildListIntStorageSlotNextTouchQuery(req *ListIntStorageSlotNextTouchRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "address", "slot_key", "next_touch_block"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "address", "slot_key", "next_touch_block"}

	return BuildParameterizedQuery("int_storage_slot_next_touch", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotNextTouchQuery constructs a parameterized SQL query from a GetIntStorageSlotNextTouchRequest
func BuildGetIntStorageSlotNextTouchQuery(req *GetIntStorageSlotNextTouchRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_next_touch", columns, qb, orderByClause, 1, 0, options...)
}
