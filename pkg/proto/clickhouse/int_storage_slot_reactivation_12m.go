...
// SQL query builder for int_storage_slot_reactivation_12m
...
// BuildListIntStorageSlotReactivation12MQuery constructs a parameterized SQL query from a ListIntStorageSlotReactivation12MRequest
func BuildListIntStorageSlotReactivation12MQuery(req *ListIntStorageSlotReactivation12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_12m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReactivation12MQuery constructs a parameterized SQL query from a GetIntStorageSlotReactivation12MRequest
func BuildGetIntStorageSlotReactivation12MQuery(req *GetIntStorageSlotReactivation12MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_12m", columns, qb, orderByClause, 1, 0, options...)
}
