...
// SQL query builder for int_storage_slot_reactivation_18m
...
// BuildListIntStorageSlotReactivation18MQuery constructs a parameterized SQL query from a ListIntStorageSlotReactivation18MRequest
func BuildListIntStorageSlotReactivation18MQuery(req *ListIntStorageSlotReactivation18MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_18m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReactivation18MQuery constructs a parameterized SQL query from a GetIntStorageSlotReactivation18MRequest
func BuildGetIntStorageSlotReactivation18MQuery(req *GetIntStorageSlotReactivation18MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_18m", columns, qb, orderByClause, 1, 0, options...)
}
