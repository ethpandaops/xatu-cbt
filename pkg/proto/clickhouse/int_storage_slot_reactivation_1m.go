...
// SQL query builder for int_storage_slot_reactivation_1m
...
// BuildListIntStorageSlotReactivation1MQuery constructs a parameterized SQL query from a ListIntStorageSlotReactivation1MRequest
func BuildListIntStorageSlotReactivation1MQuery(req *ListIntStorageSlotReactivation1MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_1m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReactivation1MQuery constructs a parameterized SQL query from a GetIntStorageSlotReactivation1MRequest
func BuildGetIntStorageSlotReactivation1MQuery(req *GetIntStorageSlotReactivation1MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_1m", columns, qb, orderByClause, 1, 0, options...)
}
