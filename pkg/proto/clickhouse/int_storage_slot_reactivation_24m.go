...
// SQL query builder for int_storage_slot_reactivation_24m
...
// BuildListIntStorageSlotReactivation24MQuery constructs a parameterized SQL query from a ListIntStorageSlotReactivation24MRequest
func BuildListIntStorageSlotReactivation24MQuery(req *ListIntStorageSlotReactivation24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_24m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReactivation24MQuery constructs a parameterized SQL query from a GetIntStorageSlotReactivation24MRequest
func BuildGetIntStorageSlotReactivation24MQuery(req *GetIntStorageSlotReactivation24MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_24m", columns, qb, orderByClause, 1, 0, options...)
}
