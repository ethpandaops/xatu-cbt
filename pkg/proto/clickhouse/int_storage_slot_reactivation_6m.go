...
// SQL query builder for int_storage_slot_reactivation_6m
...
// BuildListIntStorageSlotReactivation6MQuery constructs a parameterized SQL query from a ListIntStorageSlotReactivation6MRequest
func BuildListIntStorageSlotReactivation6MQuery(req *ListIntStorageSlotReactivation6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_6m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReactivation6MQuery constructs a parameterized SQL query from a GetIntStorageSlotReactivation6MRequest
func BuildGetIntStorageSlotReactivation6MQuery(req *GetIntStorageSlotReactivation6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_6m", columns, qb, orderByClause, 1, 0, options...)
}
