...
// SQL query builder for int_storage_slot_reactivation_by_6m
...
// BuildListIntStorageSlotReactivationBy6MQuery constructs a parameterized SQL query from a ListIntStorageSlotReactivationBy6MRequest
func BuildListIntStorageSlotReactivationBy6MQuery(req *ListIntStorageSlotReactivationBy6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "address", "slot_key", "effective_bytes"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "address", "slot_key", "toUInt32(`effective_bytes`) AS `effective_bytes`"}

	return BuildParameterizedQuery("int_storage_slot_reactivation_by_6m", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReactivationBy6MQuery constructs a parameterized SQL query from a GetIntStorageSlotReactivationBy6MRequest
func BuildGetIntStorageSlotReactivationBy6MQuery(req *GetIntStorageSlotReactivationBy6MRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_reactivation_by_6m", columns, qb, orderByClause, 1, 0, options...)
}
