...
// SQL query builder for int_storage_slot_read
...
// BuildListIntStorageSlotReadQuery constructs a parameterized SQL query from a ListIntStorageSlotReadRequest
func BuildListIntStorageSlotReadQuery(req *ListIntStorageSlotReadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "address", "slot_key"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "address", "slot_key"}

	return BuildParameterizedQuery("int_storage_slot_read", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotReadQuery constructs a parameterized SQL query from a GetIntStorageSlotReadRequest
func BuildGetIntStorageSlotReadQuery(req *GetIntStorageSlotReadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_read", columns, qb, orderByClause, 1, 0, options...)
}
