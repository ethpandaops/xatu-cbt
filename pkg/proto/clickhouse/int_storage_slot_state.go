...
// SQL query builder for int_storage_slot_state
...
// BuildListIntStorageSlotStateQuery constructs a parameterized SQL query from a ListIntStorageSlotStateRequest
func BuildListIntStorageSlotStateQuery(req *ListIntStorageSlotStateRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_state", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntStorageSlotStateQuery constructs a parameterized SQL query from a GetIntStorageSlotStateRequest
func BuildGetIntStorageSlotStateQuery(req *GetIntStorageSlotStateRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_storage_slot_state", columns, qb, orderByClause, 1, 0, options...)
}
