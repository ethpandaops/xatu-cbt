...
// SQL query builder for int_token_contract_storage_state_by_block
...
// BuildListIntTokenContractStorageStateByBlockQuery constructs a parameterized SQL query from a ListIntTokenContractStorageStateByBlockRequest
func BuildListIntTokenContractStorageStateByBlockQuery(req *ListIntTokenContractStorageStateByBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "token_standard", "slots_delta", "active_slots"}
		...
		orderByClause = " ORDER BY block_number" + ", token_standard"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "token_standard", "slots_delta", "active_slots"}

	return BuildParameterizedQuery("int_token_contract_storage_state_by_block", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntTokenContractStorageStateByBlockQuery constructs a parameterized SQL query from a GetIntTokenContractStorageStateByBlockRequest
func BuildGetIntTokenContractStorageStateByBlockQuery(req *GetIntTokenContractStorageStateByBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("int_token_contract_storage_state_by_block", columns, qb, orderByClause, 1, 0, options...)
}
