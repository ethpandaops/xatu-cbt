...
// SQL query builder for int_transaction_call_frame_opcode_gas
...
// BuildListIntTransactionCallFrameOpcodeGasQuery constructs a parameterized SQL query from a ListIntTransactionCallFrameOpcodeGasRequest
//
...
func BuildListIntTransactionCallFrameOpcodeGasQuery(req *ListIntTransactionCallFrameOpcodeGasRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "transaction_hash", "transaction_index", "call_frame_id", "opcode", "count", "gas", "gas_cumulative", "error_count", "meta_network_name"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "NULLIF(`transaction_hash`, repeat('\x00', 66)) AS `transaction_hash`", "transaction_index", "call_frame_id", "opcode", "count", "gas", "gas_cumulative", "error_count", "meta_network_name"}

	return BuildParameterizedQuery("int_transaction_call_frame_opcode_gas", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetIntTransactionCallFrameOpcodeGasQuery constructs a parameterized SQL query from a GetIntTransactionCallFrameOpcodeGasRequest
func BuildGetIntTransactionCallFrameOpcodeGasQuery(req *GetIntTransactionCallFrameOpcodeGasRequest, options ...QueryOption) (SQLQuery, error) {
