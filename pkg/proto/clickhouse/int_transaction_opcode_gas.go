...
// SQL query builder for int_transaction_opcode_gas
...
// BuildGetIntTransactionOpcodeGasQuery constructs a parameterized SQL query from a GetIntTransactionOpcodeGasRequest
func BuildGetIntTransactionOpcodeGasQuery(req *GetIntTransactionOpcodeGasRequest, options ...QueryOption) (SQLQuery, error) {
